...
def initialize(consoleLogging=True):
    with INIT_LOCK:
        ...
        global BRANCH, CUR_COMMIT_HASH, CUR_COMMIT_BRANCH, ACTUAL_LOG_DIR, LOG_DIR, WEB_PORT, WEB_LOG, ENCRYPTION_VERSION, WEB_ROOT, WEB_USERNAME, WEB_PASSWORD, WEB_HOST, WEB_IPV6, USE_API, API_KEY, ENABLE_HTTPS, HTTPS_CERT, HTTPS_KEY, \
            ...
            versionCheckScheduler, VERSION_NOTIFY, AUTO_UPDATE, NOTIFY_ON_UPDATE, PROCESS_AUTOMATICALLY, UNPACK, UNPACKCLEANUP, CPU_PRESET, \
        ...
        UNPACKCLEANUP = bool(check_setting_int(CFG, 'General', 'unpackcleanup', 0))
...
def save_config():
    ...
    new_config['General']['unpackcleanup'] = int(UNPACKCLEANUP)

...
def initialize(consoleLogging=True):
    with INIT_LOCK:
        ...
        global BRANCH, GIT_RESET, GIT_REMOTE, GIT_REMOTE_URL, CUR_COMMIT_HASH, CUR_COMMIT_BRANCH, GIT_NEWVER, ACTUAL_LOG_DIR, LOG_DIR, LOG_NR, LOG_SIZE, WEB_PORT, WEB_LOG, ENCRYPTION_VERSION, ENCRYPTION_SECRET, WEB_ROOT, WEB_USERNAME, WEB_PASSWORD, WEB_HOST, WEB_IPV6, WEB_COOKIE_SECRET, WEB_USE_GZIP, API_KEY, API_ROOT, ENABLE_HTTPS, HTTPS_CERT, HTTPS_KEY, \
            ...
            showUpdateScheduler, __INITIALIZED__, INDEXER_DEFAULT_LANGUAGE, EP_DEFAULT_DELETED_STATUS, LAUNCH_BROWSER, TRASH_REMOVE_SHOW, TRASH_ROTATE_LOGS, SORT_ARTICLE, COUNT_SKIPPED_EPISODES, showList, loadingShowList, \
        ...
        COUNT_SKIPPED_EPISODES = bool(check_setting_int(CFG, 'General', 'count_skipped_episodes', 0))
...
def save_config():
    ...
    new_config['General']['count_skipped_episodes'] = int(COUNT_SKIPPED_EPISODES)

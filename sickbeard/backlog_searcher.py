...
class BacklogSearcher(object):
    def __init__(self, *args, **kwargs):
        ...
        self.cycleTime = sickbeard.BACKLOG_SEARCHER_FREQ / 60 / 24
        self.amActive = False
        self.amPaused = False
    ...
    def searchBacklog(self, which_shows=None):
        ...
        for curShow in show_list:
            ...
            for season, segment in segments.iteritems():
                ...
                sickbeard.searchQueue.add_item(backlog_queue_item)  # @UndefinedVariable
            else:
...
def get_backlog_cycle_time():
    cycletime = sickbeard.DAILY_SEARCHER_FREQ * 2 + 7

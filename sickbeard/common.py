...
class Quality:
    ...
    def sceneQuality(name, anime=False):
        ...
        if checkName([r"(pdtv|hd.?tv|dsr|tvrip).(xvid|x26[45]|h.?26[45])"], all) and not checkName([r"(720|1080)[pi]"], all) and\
            ...
            ret = Quality.SDTV
        elif checkName([r"web.?dl|webrip|huluhd", r"xvid|x26[45]|h.?26[45]"], all) and not checkName([r"(720|1080)[pi]"], all):
            ret = Quality.SDTV
            ...
            ret = Quality.FULLHDTV
        elif checkName([r"720p", r"web.?dl|webrip|webhd(rip)?|netflixhd|ituneshd|amazonhd|huluhd"], all) or checkName([r"720p", r"itunes", r"(x|h).?26[45]"], all):
            ret = Quality.HDWEBDL
        elif checkName([r"1080p", r"web.?dl|webrip|webhd(rip)?|netflixhd|ituneshd|amazonhd|huluhd"], all) or checkName([r"1080p", r"itunes", r"(x|h).?26[45]"], all):
            ret = Quality.FULLHDWEBDL
        elif checkName([r"720p", r"blue?-?ray|hddvd|b[rd]rip", r"(h|x)26[45]"], all):
            ret = Quality.HDBLURAY
        elif checkName([r"1080p", r"blue?-?ray|hddvd|b[rd]rip", r"(h|x)26[45]"], all):
            ret = Quality.FULLHDBLURAY

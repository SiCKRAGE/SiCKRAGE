...
class Mede8erMetadata(mediabrowser.MediaBrowserMetadata):
    ...
    def _show_data(self, show_obj):
        ...
        try:
            ...
            logger.log(u"Unable to find show with id " + str(show_obj.indexer_id) + " on tvdb, skipping it",
                       logger.ERROR)
            raise
        ...
        try:
            if myShow['seriesname'] is None or myShow['seriesname'] == "" or myShow['id'] is None or myShow['id'] == "":
                logger.log(u"Incomplete info for show with id " + str(show_obj.indexer_id) + " on tvdb, skipping it",
                           logger.ERROR)
                return False
        ...
        indexer_id = etree.SubElement(tv_node, "indexer_id")

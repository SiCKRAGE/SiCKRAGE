...
def check_valid_naming(pattern=None, multi=None, anime_type=None):
    ...
    logging.debug(
        "Checking whether the pattern " +
        pattern +
        " is valid for a single episode")
...
def check_valid_abd_naming(pattern=None):
    ...
    logging.debug("Checking whether the pattern " + pattern +
                  " is valid for an air-by-date episode")
...
def check_valid_sports_naming(pattern=None):
    ...
    logging.debug(
        "Checking whether the pattern " +
        pattern +
        " is valid for an sports episode")

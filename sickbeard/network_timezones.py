...
def _update_zoneinfo():
    ...
    url_zv = 'https://sickragetv.github.io/sb_network_timezones/zoneinfo.txt'
    ...
    url_tar = u'https://sickragetv.github.io/sb_network_timezones/%s' % new_zoneinfo
...
def update_network_dict():
    ...
    url = 'https://sickragetv.github.io/sb_network_timezones/network_timezones.txt'

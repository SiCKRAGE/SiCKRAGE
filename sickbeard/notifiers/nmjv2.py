...
class NMJv2Notifier:
    ...
    def _sendNMJ(self, host):
        ...
        try:
            ...
            logging.error(
                "Unable to parse XML returned from the Popcorn Hour: update_scandir, %s" %
                (e))
            return False
        try:
            ...
            logging.error(
                "Unable to parse XML returned from the Popcorn Hour: scanner_start, %s" %
                (e))
            return False
        ...
        if int(result1) > 0:
            ...
            logging.error(
                "Popcorn Hour returned an error: %s" %

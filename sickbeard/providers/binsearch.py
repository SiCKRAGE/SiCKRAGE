...
class BinSearchCache(tvcache.TVCache):
    ...
    def updateCache(self):
        ...
        cl = []
        for group in ['alt.binaries.boneless','alt.binaries.misc','alt.binaries.multimedia','alt.binaries.hdtv','alt.binaries.hdtv.x264','alt.binaries.tv','alt.binaries.tvseries','alt.binaries.teevee']:

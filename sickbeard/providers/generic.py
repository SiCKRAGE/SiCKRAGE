...
class TorrentProvider(GenericProvider):
    ...
    def _get_season_search_strings(self, ep_obj):
        ...
        for show_name in set(show_name_helpers.allPossibleShowNames(self.show)):
            ...
            if '\'' in ep_string:
                search_string[b'Season'].append(ep_string.replace('\'', '').encode('utf-8').strip())
                if '\'s' in ep_string:
                    search_string[b'Season'].append(ep_string.replace('\'s', '').encode('utf-8').strip())
    ...
    def _get_episode_search_strings(self, ep_obj, add_string=''):
        ...
        for show_name in set(show_name_helpers.allPossibleShowNames(ep_obj.show)):
            ...
            if '\'' in ep_string:
                search_string[b'Episode'].append(ep_string.replace('\'', '').encode('utf-8').strip())
                if '\'s' in ep_string:

...
class SearchQueue(generic_queue.GenericQueue):
    ...
    def add_item(self, item):
        if isinstance(item, DailySearchQueueItem):
            ...
            logger.log(
                u"Not adding item, it's already in the queue",
                logger.DEBUG)
    ...
    def run(self):
        ...
        try:
            ...
            if searchResult:
                ...
                logger.log(
                    u"Unable to find a download for: [" +
                    self.segment.prettyName() +
                    "]")
        ...
        if not self.show.paused:
            try:
                ...
                if searchResult:
                    ...
                    logger.log(
                        u"No needed episodes found during backlog search for: [" + self.show.name + "]")
            except Exception:
                logger.log(traceback.format_exc(), logger.DEBUG)
    ...
    def run(self):
        ...
        try:
            for epObj in self.segment:
                ...
                logger.log(
                    u"Marking episode as bad: [" + epObj.prettyName() + "]")

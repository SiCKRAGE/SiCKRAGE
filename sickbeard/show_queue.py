...
class QueueItemAdd(ShowQueueItem):
    ...
    def run(self):
        ...
        try:
            ...
            logger.log(u"Error while loading information from indexer %s. Error: %r" % (
                self.indexer_id, sickbeard.indexerApi(self.indexer).name, ex(e)), logger.ERROR)
        ...
        try:
            ...
            logger.log(u"Setting all episodes to the specified default status: " +
        ...
        try:
            ...
            logger.log(
                u"Error saving the show to the database: " +
                ex(e),
                logger.ERROR)
            logger.log(traceback.format_exc(), logger.DEBUG)
            self._finishEarly()
        ...
        try:
            ...
            logger.log(
                ...
                sickbeard.indexerApi(
                    self.show.indexer).name + ", not creating episode list: " + ex(e),
                logger.ERROR)
            logger.log(traceback.format_exc(), logger.DEBUG)
        ...
        try:
            ...
            logger.log(
                u"Error searching dir for episodes: " +
                ex(e),
                logger.ERROR)
            logger.log(traceback.format_exc(), logger.DEBUG)
        ...
        sickbeard.scene_numbering.xem_refresh(
            self.show.indexerid, self.show.indexer, force=True)
...
class QueueItemUpdate(ShowQueueItem):
    ...
    def run(self):
        ...
        try:
            ...
            logger.log(
                u"Error saving show info to the database: " +
                ex(e),
                logger.ERROR)
            logger.log(traceback.format_exc(), logger.DEBUG)
    ...
    def run(self):
        ...
        if sickbeard.USE_TRAKT:
            try:
                ...
                logger.log(
                    u"Unable to delete show from Trakt: %s. Error: %s" %
                    (self.show.name, ex(e)), logger.WARNING)

...
class TraktAPI():
    ...
    def traktRequest(self, path, data=None, headers=None,
                     url=None, method='GET', count=0):
        if None == url:
            url = self.api_url
        ...
        try:
            ...
            if not code:
                ...
                # It means there basically was no response at all
                    ...
                    logging.debug(
                        'Could not connect to Trakt. Error: {0}'.format(e))
            elif code == 502:
                ...
                logging.error(
                    'Could not connect to Trakt. Code error: {0}'.format(code))
            return {}

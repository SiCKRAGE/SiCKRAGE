...
class Home(WebRoot):
    ...
    def index(self):
        ...
        return t.render(title="Home", header="Show List", topmenu="home", showlists=showlists, submenu=self.HomeMenu(), max_download_count=self.max_download_count(), show_stat=self.show_stat())

...
% endif
    ...
    <tr><td class="infoTableHeader"><i class="icon16-web"></i> Forums</td><td class="infoTableCell"><a href="${anon_url('http://sickrage.ca/forums/')}" rel="noreferrer" onclick="window.open(this.href, '_blank'); return false;">http://www.sickrage.ca/forums/</a></td></tr>

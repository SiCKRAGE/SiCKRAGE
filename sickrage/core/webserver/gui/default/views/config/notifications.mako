                                ...
                                <div class="field-pair">
                                    ...
                                    <label>
                                        ...
                                        <span class="component-desc">(<a
                                                ...
                                                rel="noreferrer"
                                                onclick="window.open(this.href, '_blank'); return false;"><u>Finding your account token</u></a>)</span>
                                    </label>
                                </div>
                            ...
                            <div id="content_use_plex_client">
                                ...
                                <div class="field-pair">
                                    <label for="plex_host">
                                        ...
                                        <span class="component-desc">
                                        <input type="text" name="plex_host" id="plex_host"
                                ...
                                <div class="field-pair">
                                    ...
                                    <div class=clear-left><p>Note: some Plex clients <b class="boldest">do not</b>
                                        support
                                        notifications e.g. Plexapp for Samsung TVs</p></div>
                                </div>

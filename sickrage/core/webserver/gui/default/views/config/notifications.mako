                        ...
                        <div id="content_use_trakt">
                            ...
                            <div class="field-pair">
                                <label for="trakt_use_rolling_download">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" class="enabler" name="trakt_use_rolling_download"
                                                id="trakt_use_rolling_download" ${('', 'checked="checked"')[bool(sickrage.srCore.srConfig.TRAKT_USE_ROLLING_DOWNLOAD)]}/>
                            ...
                            <div id="content_trakt_use_rolling_download">
                                  <div class="field-pair">
                                    <label for="trakt_rolling_num_ep">
                                        ...
                                        <span class="component-desc">
                                        <input type="number" name="trakt_rolling_num_ep" id="trakt_rolling_num_ep" value="${sickrage.srCore.srConfig.TRAKT_ROLLING_NUM_EP}"  class="form-control input-sm input75"/>
                                    </label>
                                    <label>
                                        <span class="component-title">&nbsp;</span>
                                ...
                                <div class="field-pair">
                                    <label for="trakt_rolling_frequency">
                                        ...
                                        <input type="text" name="trakt_rolling_frequency" id="trakt_rolling_frequency" value="${sickrage.srCore.srConfig.TRAKT_ROLLING_FREQUENCY}" class="form-control input-sm input250" />
                                    </label>
                                    <p>
                                  ...
                                  <div class="field-pair">
                                    <label for="trakt_rolling_add_paused">
                                        ...
                                        <span class="component-desc">
                                        <input type="checkbox" name="trakt_rolling_add_paused" id="trakt_rolling_add_paused"  ${('', 'checked="checked"')[bool(sickrage.srCore.srConfig.TRAKT_ROLLING_ADD_PAUSED)]} />
                                    </label>
                                    <label>
                                        <span class="component-title">&nbsp;</span>

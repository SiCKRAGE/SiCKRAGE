    ...
    <div id="config">
        <form id="configForm" action="saveProviders" method="post">
            <ul class="nav nav-tabs">
                ...
                % if sickrage.srCore.srConfig.USE_NZBS:
                    <li><a data-toggle="tab" href="#core-tab-pane3">Configure Custom Newznab Providers</a></li>
                % endif
                % if sickrage.srCore.srConfig.USE_TORRENTS:
                    <li><a data-toggle="tab" href="#core-tab-pane4">Configure Custom Torrent Providers</a></li>
                % endif
            </ul>

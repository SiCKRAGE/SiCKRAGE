                    ...
                    <div id="core-component-group1" class="component-group">
                        ...
                        <fieldset class="component-group-list">
                            ...
                            <div class="field-pair">
                                ...
                                <span class="component-desc">
                                    <input type="text" name="dailysearch_frequency"
                                           ...
                                           class="form-control input-sm input75"/>
                                    <p>time in minutes between searches
                                        (min. ${sickrage.srConfig.MIN_DAILY_SEARCHER_FREQ})</p>
                                    </span>
                                </label>
                            </div>
                            ...
                            <div class="field-pair">
                                ...
                                <span class="component-desc">
                                    <input type="text" name="usenet_retention"
                                           value="${sickrage.srConfig.USENET_RETENTION}"
                                           class="form-control input-sm input75"/>
                            ...
                            <div class="field-pair">
                                ...
                                <span class="component-desc">
                                    <input type="text" name="ignored_subs_list"
                                           value="${sickrage.srConfig.IGNORED_SUBS_LIST}"
                                           class="form-control input-sm input350" autocapitalize="off"/>
                        ...
                        <fieldset class="component-group-list">
                            ...
                            <div id="content_use_nzbs">
                                ...
                                <div id="blackhole_settings">
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="nzb_dir" id="nzb_dir"
                                               value="${sickrage.srConfig.NZB_DIR}"
                                               class="form-control input-sm input350" autocapitalize="off"/>
                                ...
                                <div id="sabnzbd_settings">
                                    ...
                                    <span class="component-desc">
                                        <input type="text" id="sab_host" name="sab_host"
                                               value="${sickrage.srConfig.SAB_HOST}"
                                               class="form-control input-sm input350" autocapitalize="off"/>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="sab_username" id="sab_username"
                                               value="${sickrage.srConfig.SAB_USERNAME}"
                                    ...
                                    <span class="component-desc">
                                        <input type="password" name="sab_password" id="sab_password"
                                               value="${sickrage.srConfig.SAB_PASSWORD}"
                                               class="form-control input-sm input200"
                                               autocapitalize="off"/>
                                        <p>(blank for none)</p>
                                    </span>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="sab_apikey" id="sab_apikey"
                                               value="${sickrage.srConfig.SAB_APIKEY}"
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="sab_category" id="sab_category"
                                               value="${sickrage.srConfig.SAB_CATEGORY}"
                                               class="form-control input-sm input200"/>
                                ...
                                <div id="nzbget_settings">
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="nzbget_host" id="nzbget_host"
                                               value="${sickrage.srConfig.NZBGET_HOST}"
                                               class="form-control input-sm input350"
                                               autocapitalize="off"/>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="nzbget_username"
                                               value="${sickrage.srConfig.NZBGET_USERNAME}"
                                            ...
                                            <label>
                                                ...
                                                <span class="component-desc">
                                                    <input type="text" name="torrent_dir" id="torrent_dir"
                                                           value="${sickrage.srConfig.TORRENT_DIR}"
                                                           class="form-control input-sm input350"
                                                           autocapitalize="off" />
                                ...
                                <div id="options_torrent_clients">
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="torrent_host" id="torrent_host"
                                               value="${sickrage.srConfig.TORRENT_HOST}"
                                               class="form-control input-sm input350"
                                               autocapitalize="off"/>
                                        <div class="clear-left">
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="torrent_rpcurl" id="torrent_rpcurl"
                                               value="${sickrage.srConfig.TORRENT_RPCURL}"
                                               class="form-control input-sm input350"
                                               autocapitalize="off"/>
                                        <div class="clear-left">
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="torrent_path" id="torrent_path"
                                               value="${sickrage.srConfig.TORRENT_PATH}"
                                               class="form-control input-sm input350"
                                               autocapitalize="off"/>

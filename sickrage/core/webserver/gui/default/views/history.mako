    ...
    <div class="h2footer pull-right">
        ...
        <span class="badge" style="background-color: #333333;"> Layout:
            <select name="HistoryLayout" class="form-control form-control-inline input-sm"
                ...
                <option value="${parent.web_root()}/setHistoryLayout/?layout=compact"  ${('', 'selected="selected"')[sickrage.srCore.srConfig.HISTORY_LAYOUT == 'compact']}>
                    Compact
                </option>
                <option value="${parent.web_root()}/setHistoryLayout/?layout=detailed" ${('', 'selected="selected"')[sickrage.srCore.srConfig.HISTORY_LAYOUT == 'detailed']}>
                    Detailed
                </option>
            </select>
        </span>
                ...
                % for hItem in historyResults:
                    ...
                    <tr>
                        ...
                        <td class="tvShow" width="35%"><a
                                href="${parent.web_root()}/home/displayShow?show=${hItem["show_id"]}#S${hItem["season"]}E${hItem["episode"]}">${hItem["show_name"]}
                        ...
                        <td align="center" ${('', 'class="subtitles_column"')[curStatus == SUBTITLED]}>
                            % if curStatus == SUBTITLED:
                                <img width="16" height="11" style="vertical-align:middle;"
                                     src="${parent.web_root()}/images/subtitles/flags/${hItem['resource']}.png"
                            ...
                            % else:
                                % if hItem["provider"] > 0:
                                    % if curStatus in [SNATCHED, FAILED]:
                                        ...
                                        % endif
                                    % else:
                                        <img src="${parent.web_root()}/images/subtitles/${hItem['provider']}.png" width="16" height="16"
                                             style="vertical-align:middle;"/> <span
                ...
                % for hItem in compactResults:
                    <tr>
                        ...
                        <td class="tvShow" width="25%">
                            <span><a
                                    href="${parent.web_root()}/home/displayShow?show=${hItem["show_id"]}#season-${hItem["season"]}">${hItem["show_name"]}
                        ...
                        <td align="center" data-provider="${str(sorted(hItem["actions"])[0]["provider"])}">
                            % for action in sorted(hItem["actions"]):
                                ...
                                % if curStatus in [SNATCHED, FAILED]:
                                    ...
                                    % else:
                                        <img src="${parent.web_root()}/images/providers/missing.png" width="16" height="16"
                        ...
                        % if sickrage.srCore.srConfig.USE_SUBTITLES:
                            <td align="center">
                                % for action in sorted(hItem["actions"]):
                                    <% curStatus, curQuality = Quality.splitCompositeStatus(int(action["action"])) %>
                                    % if curStatus == SUBTITLED:
                                        <img src="${parent.web_root()}/images/subtitles/${action['provider']}.png" width="16" height="16"
                                        ...
                                        <img width="16" height="11" style="vertical-align:middle;!important;"
                                             src="${parent.web_root()}/images/subtitles/flags/${action['resource']}.png"
                                             onError="this.onerror=null;this.src='/images/flags/unknown.png';">
                                        &nbsp;
                                    % endif
                                % endfor

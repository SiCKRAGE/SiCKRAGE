...
<%block name="content">
    ...
    <div class="pull-left form-inline">
        Change Show:
        <div class="navShow"><img id="prevShow" src="${srWebRoot}/images/prev.png" alt="&lt;&lt;" title="Prev Show"/></div>
        ...
        <div class="navShow"><img id="nextShow" src="${srWebRoot}/images/next.png" alt="&gt;&gt;" title="Next Show"/></div>
    </div>
                ...
                <table style="width:180px; float: right; vertical-align: middle; height: 100%;">
                    ...
                    <tr>
                        ...
                        <td><img src="${srWebRoot}/images/subtitles/flags/${info_flag}.png" width="16" height="11"
                                 ...
                                 onError="this.onerror=null;this.src='${srWebRoot}/images/flags/unknown.png';"/></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><img src="${srWebRoot}/images/${("no16.png", "yes16.png")[bool(show.archive_firstmatch)]}"
                    ...
                    % if ( int(epResult["status"]) in Quality.SNATCHED + Quality.DOWNLOADED ) and sickrage.srCore.srConfig.USE_FAILED_DOWNLOADS:
                        <a class="epRetry"
                           ...
                           href="retryEpisode?show=${show.indexerid}&amp;season=${epResult["season"]}&amp;episode=${epResult["episode"]}"><img
                                src="${srWebRoot}/images/search16.png" height="16" alt="retry" title="Retry Download"/></a>
                    % else:
                        <a class="epSearch"
                           id="${str(show.indexerid)}x${str(epResult["season"])}x${str(epResult["episode"])}"
                           name="${str(show.indexerid)}x${str(epResult["season"])}x${str(epResult["episode"])}"

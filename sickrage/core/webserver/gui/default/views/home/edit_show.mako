...
<%block name="content">
    ...
    <div id="show">
        <form action="editShow" method="post">
                        ...
                        <div class="field-pair">
                            <label for="dvdorder">
                                ...
                                <span class="component-desc">
                                            ...
                                            <div class="clear-left"><p>A "Force Full Update" is necessary, and if you
                                                have
                            ...
                            <label for="SceneName">
                                ...
                                <span class="component-desc">
                                        ...
                                        class="btn btn-inline" type="button" value="Add" id="addSceneName"/><br><br>
                                            ...
                                            <div class="clear-left"><p>This will affect episode search on NZB and
                                                torrent
            ...
            <br><input id="submit" type="submit" value="Save Changes" class="btn pull-left config_submitter button">
        </form>
    </div>
</%block>

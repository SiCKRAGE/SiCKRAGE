    ...
    <div class="h2footer pull-right">
        ...
        % if sickrage.srCore.srConfig.HOME_LAYOUT == 'poster':
            <span class="badge" style="background-color: #333333;">Sort By:
                <select id="postersort" class="form-control form-control-inline input-sm">
                    <option value="name"
                            data-sort="${parent.web_root()}/setPosterSortBy/?sort=name" ${('', 'selected="selected"')[sickrage.srCore.srConfig.POSTER_SORTBY == 'name']}>
                        Name
                    </option>
                    <option value="date"
                            data-sort="${parent.web_root()}/setPosterSortBy/?sort=date" ${('', 'selected="selected"')[sickrage.srCore.srConfig.POSTER_SORTBY == 'date']}>
                        Next Episode
                    </option>
                    <option value="network"
                            data-sort="${parent.web_root()}/setPosterSortBy/?sort=network" ${('', 'selected="selected"')[sickrage.srCore.srConfig.POSTER_SORTBY == 'network']}>
                        Network
                    </option>
                    <option value="progress"
                            data-sort="${parent.web_root()}/setPosterSortBy/?sort=progress" ${('', 'selected="selected"')[sickrage.srCore.srConfig.POSTER_SORTBY == 'progress']}>
                        Progress
                    </option>
                </select>
            </span>
            ...
            <span class="badge" style="background-color: #333333;">Sort Order:
                <select id="postersortdirection" class="form-control form-control-inline input-sm">
                    <option value="true"
                            data-sort="${parent.web_root()}/setPosterSortDir/?direction=1" ${('', 'selected="selected"')[sickrage.srCore.srConfig.POSTER_SORTDIR == 1]}>
                        Asc
                    </option>
                    <option value="false"
                            data-sort="${parent.web_root()}/setPosterSortDir/?direction=0" ${('', 'selected="selected"')[sickrage.srCore.srConfig.POSTER_SORTDIR == 0]}>
                        Desc
                    </option>
                </select>
            </span>
        ...
        <span class="badge" style="background-color: #333333;">Layout:
            <select name="layout" class="form-control form-control-inline input-sm" onchange="location = this.options[this.selectedIndex].value;">
                <option value="${parent.web_root()}/setHomeLayout/?layout=poster" ${('', 'selected="selected"')[sickrage.srCore.srConfig.HOME_LAYOUT == 'poster']}>
                    Poster
                </option>
                <option value="${parent.web_root()}/setHomeLayout/?layout=small" ${('', 'selected="selected"')[sickrage.srCore.srConfig.HOME_LAYOUT == 'small']}>
                    Small Poster
                </option>
                <option value="${parent.web_root()}/setHomeLayout/?layout=banner" ${('', 'selected="selected"')[sickrage.srCore.srConfig.HOME_LAYOUT == 'banner']}>
                    Banner
                </option>
                <option value="${parent.web_root()}/setHomeLayout/?layout=simple" ${('', 'selected="selected"')[sickrage.srCore.srConfig.HOME_LAYOUT == 'simple']}>
                    Simple
                </option>
            </select>
        </span>
                        ...
                        % if not curLoadingShow.show:
                            <div class="show" data-name="0" data-date="010101" data-network="0" data-progress="101">
                                <img alt="" title="${curLoadingShow.show_name}" class="show-image"
                                     style="border-bottom: 1px solid #111;" src="${parent.web_root()}/images/poster.png"/>
                    ...
                    % for curShow in myShowList:
                        ...
                        <div class="show" id="show${curShow.indexerid}" data-name="${curShow.name}" data-date="${data_date}" data-network="${curShow.network}" data-progress="${progressbar_percent}">
                            <div class="show-image">
                                <a href="${parent.web_root()}/home/displayShow?show=${curShow.indexerid}"><img alt="" class="show-image" src="${showImage(curShow.indexerid, 'poster_thumb')}" /></a>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="show-table">
                                        % if sickrage.srCore.srConfig.HOME_LAYOUT != 'simple':
                                            ...
                                            % else:
                                                <span title="No Network"><img class="show-network-image" src="${parent.web_root()}/images/network/nonetwork.png" alt="No Network" title="No Network" /></span>
                                            % endif
                                        % else:
        ...
        % else:
            <table id="showListTable${curListType}" class="sickrageTable tablesorter" cellspacing="1" border="0" cellpadding="0">
                ...
                <tfoot class="hidden-print">
                    <tr>
                        <th rowspan="1" colspan="1" align="center"><a href="${parent.web_root()}/home/addShows/">Add ${('Show', 'Anime')[curListType == 'Anime']}</a></th>
                        <th>&nbsp;</th>
                        <th>&nbsp;</th>
                        <th>&nbsp;</th>
                        <th>&nbsp;</th>
                    ...
                    % for curShow in myShowList:
                        ...
                        <tr>
                            ...
                            % if sickrage.srCore.srConfig.HOME_LAYOUT == 'small':
                                <td class="tvShow">
                                    <div class="imgsmallposter ${sickrage.srCore.srConfig.HOME_LAYOUT}">
                                        <a href="${parent.web_root()}/home/displayShow?show=${curShow.indexerid}" title="${curShow.name}">
                                            <img src="${showImage(curShow.indexerid, 'poster_thumb')}" class="${sickrage.srCore.srConfig.HOME_LAYOUT}"
                                                 alt="${curShow.indexerid}"/>
                                        </a>
                                        <a href="${parent.web_root()}/home/displayShow?show=${curShow.indexerid}" style="vertical-align: middle;">${curShow.name}</a>
                                    </div>
                                </td>
                            % elif sickrage.srCore.srConfig.HOME_LAYOUT == 'banner':
                                <td>
                                    ...
                                    <div class="imgbanner ${sickrage.srCore.srConfig.HOME_LAYOUT}">
                                        <a href="${parent.web_root()}/home/displayShow?show=${curShow.indexerid}">
                            ...
                            % elif sickrage.srCore.srConfig.HOME_LAYOUT == 'simple':
                                <td class="tvShow"><a href="${parent.web_root()}/home/displayShow?show=${curShow.indexerid}">${curShow.name}</a></td>
                            % endif
                            ...
                            % if sickrage.srCore.srConfig.HOME_LAYOUT != 'simple':
                                <td align="center">
                                    ...
                                    % else:
                                        <span title="No Network" class="hidden-print"><img id="network" width="54" height="27" src="${parent.web_root()}/images/network/nonetwork.png" alt="No Network" title="No Network" /></span>
                            ...
                            <td align="center">
                                ...
                                <img src="${parent.web_root()}/images/${('no16.png', 'yes16.png')[bool(paused)]}" alt="${('No', 'Yes')[bool(paused)]}" width="16" height="16" />
                            </td>

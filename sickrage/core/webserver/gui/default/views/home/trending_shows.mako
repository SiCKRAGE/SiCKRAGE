            ...
            <% show_url = 'http://www.trakt.tv/shows/%s' % cur_show['show']['ids']['slug'] %>
                <div class="trakt_show" data-name="${cur_show['show']['title']}"
                    ...
                    <div class="traktContainer">
                        ...
                        <div class="clearfix">
                            <p>${int(cur_show['show']['rating']*10)}% <img src="${srWebRoot}/images/heart.png"></p>
                            <i>${cur_show['show']['votes']} votes</i>
                            <div class="traktShowTitleIcons">
                                <a href="${srWebRoot}/home/addShows/addTraktShow?indexer_id=${cur_show['show']['ids']['tvdb']}&amp;showName=${cur_show['show']['title']}"
                                   class="btn btn-xs">Add Show</a>
                                % if blacklist:
                                    <a href="${srWebRoot}/home/addShows/addShowToBlacklist?indexer_id=${cur_show['show']['ids']['tvdb'] or cur_show['show']['ids']['tvrage']}"

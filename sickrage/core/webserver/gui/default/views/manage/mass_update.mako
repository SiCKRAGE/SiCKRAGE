            ...
            <tbody>
                ...
                % for curShow in myShowList:
                    ...
                    <tr>
                        ...
                        <td class="tvShow"><a href="${parent.web_root()}/home/displayShow?show=${curShow.indexerid}">${curShow.name}</a>
                        </td>
                        <td align="center">${renderQualityPill(curShow.quality, showTitle=True)}</td>
                        <td align="center"><img
                                src="${parent.web_root()}/images/${('no16.png" alt="N"', 'yes16.png" alt="Y"')[bool(curShow.is_sports)]}"
                                width="16" height="16"/></td>
                        <td align="center"><img
                                src="${parent.web_root()}/images/${('no16.png" alt="N"', 'yes16.png" alt="Y"')[bool(curShow.is_scene)]}"
                                width="16" height="16"/></td>
                        <td align="center"><img
                                src="${parent.web_root()}/images/${('no16.png" alt="N"', 'yes16.png" alt="Y"')[bool(curShow.is_anime)]}"
                                width="16" height="16"/></td>
                        <td align="center"><img
                                src="${parent.web_root()}/images/${('no16.png" alt="N"', 'yes16.png" alt="Y"')[not bool(curShow.flatten_folders)]}"
                                width="16" height="16"/></td>
                        <td align="center"><img
                                src="${parent.web_root()}/images/${('no16.png" alt="N"', 'yes16.png" alt="Y"')[bool(curShow.archive_firstmatch)]}"
                                width="16" height="16"/></td>
                        <td align="center"><img
                                src="${parent.web_root()}/images/${('no16.png" alt="N"', 'yes16.png" alt="Y"')[bool(curShow.paused)]}"
                                width="16" height="16"/></td>
                        <td align="center"><img
                                src="${parent.web_root()}/images/${('no16.png" alt="N"', 'yes16.png" alt="Y"')[bool(curShow.subtitles)]}"
                                width="16" height="16"/></td>

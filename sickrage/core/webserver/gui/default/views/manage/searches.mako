...
<%block name="content">
    <div id="content800">
        <div id="summary2" class="align-left">
            ...
            <a class="btn" href="${parent.web_root()}/manage/manageSearches/forceBacklog"><i class="icon-exclamation-sign"></i> Force</a>
            <a class="btn" href="${parent.web_root()}/manage/manageSearches/pauseBacklog?paused=${('1', '0')[bool(backlogPaused)]}"><i
            ...
            <a class="btn" href="${parent.web_root()}/manage/manageSearches/forceSearch"><i class="icon-exclamation-sign"></i> Force</a>
            <br/>
            <br/>
            ...
            <a class="btn ${('disabled', '')[bool(sickrage.srCore.srConfig.DOWNLOAD_PROPERS)]}"
               href="${parent.web_root()}/manage/manageSearches/forceFindPropers"><i class="icon-exclamation-sign"></i> Force
            </a>
            <br/>
            <br/>

                ...
                <div id="config-components">
                    ...
                    <div id="core-component-group1" class="tab-pane active component-group">
                        <div class="component-group-desc">
                            <img class="notifier-icon" src="${srRoot}/images/anidb24.png" alt="AniDB" title="AniDB"
                                 width="24" height="24"/>
                        ...
                        <fieldset class="component-group-list">
                            <div class="field-pair">
                                <input type="checkbox" class="enabler" name="use_anidb"
                                       id="use_anidb" ${('', 'checked="checked"')[bool(sickrage.USE_ANIDB)]} />
                            ...
                            <div id="content_use_anidb">
                                <div class="field-pair">
                                    <label class="nocheck">
                                        ...
                                        <input type="text" name="anidb_username" id="anidb_username"
                                               value="${sickrage.ANIDB_USERNAME}" class="form-control input-sm input350"
                                               autocapitalize="off"/>
                                    </label>
                                    <label class="nocheck">
                                ...
                                <div class="field-pair">
                                    <label class="nocheck">
                                        ...
                                        <input type="password" name="anidb_password" id="anidb_password"
                                               value="${sickrage.ANIDB_PASSWORD}" class="form-control input-sm input350"
                                               autocapitalize="off"/>
                                    </label>
                                    <label class="nocheck">
                                        <span class="component-title">&nbsp;</span>
                                ...
                                <div class="field-pair">
                                    <input type="checkbox" name="anidb_use_mylist"
                                           id="anidb_use_mylist" ${('', 'checked="checked"')[bool(sickrage.ANIDB_USE_MYLIST)]}/>
                                    <label>
                        ...
                        <fieldset class="component-group-list">
                            <div class="field-pair">
                                <input type="checkbox" class="enabler" name="split_home"
                                       id="split_home" ${('', 'checked="checked"')[bool(sickrage.ANIME_SPLIT_HOME)]}/>
                                <label for="use_notifo">

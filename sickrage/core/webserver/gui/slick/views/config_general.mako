                    ...
                    <fieldset class="component-group-list">
                            ...
                            <label for="indexerDefaultLang">
                                ...
                                <span class="component-desc">
                                    <select name="indexerDefaultLang" id="indexerDefaultLang"
                                            ...
                                            data-language=${sickrage.srCore.CONFIG.INDEXER_DEFAULT_LANGUAGE} data-available="${','.join(sickrage.srCore.INDEXER_API().config[b'valid_languages'])}"></select>
                            ...
                            <label for="launch_browser">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="launch_browser"
                                           id="launch_browser" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.LAUNCH_BROWSER)]}/>
                            ...
                            <label for="default_page">
                                ...
                                <span class="component-desc">
                                    <select id="default_page" name="default_page" class="form-control input-sm">
                                        <option value="home" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.DEFAULT_PAGE == 'home']}>
                                            Shows
                                        </option>
                                        <option value="schedule" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.DEFAULT_PAGE == 'schedule']}>
                                            Schedule
                                        </option>
                                        <option value="history" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.DEFAULT_PAGE == 'history']}>
                                            History
                                        </option>
                                        <option value="news" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.DEFAULT_PAGE == 'news']}>
                                            News
                                        </option>
                                        <option value="IRC" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.DEFAULT_PAGE == 'IRC']}>
                                            IRC
                                        </option>
                                    </select>
                            ...
                            <label for="showupdate_hour">
                                ...
                                <span class="component-desc">
                                    <input type="text" name="showupdate_hour" id="showupdate_hour"
                                           value="${sickrage.srCore.CONFIG.SHOWUPDATE_HOUR}" class="form-control input-sm input75"/>
                            ...
                            <span class="component-desc">
                                <label for="trash_remove_show" class="nextline-block">
                                    <input type="checkbox" name="trash_remove_show"
                                           id="trash_remove_show" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.TRASH_REMOVE_SHOW)]}/>
                                ...
                                <label for="trash_rotate_logs" class="nextline-block">
                                    <input type="checkbox" name="trash_rotate_logs"
                                           id="trash_rotate_logs" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.TRASH_ROTATE_LOGS)]}/>
                        ...
                        <div class="field-pair">
                            <label for="log_dir">
                                ...
                                <span class="component-desc">
                                    <input type="text" name="log_dir" id="log_dir" value="${sickrage.srCore.CONFIG.LOG_DIR}"
                        ...
                        <div class="field-pair">
                            <label for="log_nr">
                                ...
                                <span class="component-desc">
                                    <input type="text" name="log_nr" id="log_nr" value="${sickrage.srCore.CONFIG.LOG_NR}"
                        ...
                        <div class="field-pair">
                            <label for="log_size">
                                ...
                                <span class="component-desc">
                                    <input type="text" name="log_size" id="log_size" value="${sickrage.srCore.CONFIG.LOG_SIZE}"
                                           class="form-control input-sm input75"/>
                                ...
                                <span class="component-desc">
                                    <select id="indexer_default" name="indexer_default" class="form-control input-sm">
                                        ...
                                        % for indexer in sickrage.srCore.INDEXER_API().indexers:
                                            <option value="${indexer}" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.INDEXER_DEFAULT == indexer]}>${sickrage.srCore.INDEXER_API().indexers[indexer]}</option>
                                        % endfor
                                    </select>
                            ...
                            <label for="indexer_timeout">
                                ...
                                <span class="component-desc">
                                    <input type="text" name="indexer_timeout" id="indexer_timeout"
                                           value="${sickrage.srCore.CONFIG.INDEXER_TIMEOUT}" class="form-control input-sm input75"/>
                            ...
                            <label for="version_notify">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="version_notify"
                                           id="version_notify" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.VERSION_NOTIFY)]}/>
                            ...
                            <label for="auto_update">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="auto_update"
                                           id="auto_update" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.AUTO_UPDATE)]}/>
                            ...
                            <label>
                                ...
                                <span class="component-desc">
                                    <input type="text" name="update_frequency" id="update_frequency"
                                           value="${sickrage.srCore.CONFIG.VERSION_UPDATER_FREQ}"
                                           class="form-control input-sm input75"/>
                            ...
                            <label for="notify_on_update">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="notify_on_update"
                                           id="notify_on_update" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.NOTIFY_ON_UPDATE)]}/>
                    ...
                    <fieldset class="component-group-list">
                            ...
                            <label for="theme_name">
                                ...
                                <span class="component-desc">
                                    <select id="theme_name" name="theme_name" class="form-control input-sm">
                                        <option value="dark" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.THEME_NAME == 'dark']}>
                                            Dark
                                        </option>
                                        <option value="light" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.THEME_NAME == 'light']}>
                                            Light
                                        </option>
                                    </select>
                            ...
                            <label for="display_all_seasons">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="display_all_seasons"
                                           id="display_all_seasons" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.DISPLAY_ALL_SEASONS)]}>
                            ...
                            <label for="sort_article">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="sort_article"
                                           id="sort_article" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.SORT_ARTICLE)]}/>
                            ...
                            <label for="filter_row">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="filter_row"
                                           id="filter_row" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.FILTER_ROW)]}/>
                            ...
                            <label for="coming_eps_missed_range">
                                ...
                                <span class="component-desc">
                                    <input type="number" step="1" min="7" name="coming_eps_missed_range"
                                           id="coming_eps_missed_range" value="${sickrage.srCore.CONFIG.COMING_EPS_MISSED_RANGE}"
                                           class="form-control input-sm input75"/>
                            ...
                            <label for="fuzzy_dating">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="fuzzy_dating" id="fuzzy_dating"
                                           class="viewIf datePresets" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.FUZZY_DATING)]}/>
                                    <p>move absolute dates into tooltips and display e.g. "Last Thu", "On Tue"</p>
                                </span>
                            </label>
                        </div>
                        <div class="field-pair show_if_fuzzy_dating ${(' metadataDiv', '')[not bool(sickrage.srCore.CONFIG.FUZZY_DATING)]}">
                            <label for="trim_zero">
                                <span class="component-title">Trim zero padding</span>
                                <span class="component-desc">
                                    <input type="checkbox" name="trim_zero"
                                           id="trim_zero" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.TRIM_ZERO)]}/>
                        ...
                        <div class="field-pair">
                            <label for="date_presets">
                                ...
                                <span class="component-desc">
                                    <select class="form-control input-sm ${(' metadataDiv', '')[bool(sickrage.srCore.CONFIG.FUZZY_DATING)]}"
                                            id="date_presets${('_na', '')[bool(sickrage.srCore.CONFIG.FUZZY_DATING)]}"
                                            name="date_preset${('_na', '')[bool(sickrage.srCore.CONFIG.FUZZY_DATING)]}">
                                        % for cur_preset in date_presets:
                                            <option value="${cur_preset}" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.DATE_PRESET == cur_preset or ("%x" == sickrage.srCore.CONFIG.DATE_PRESET and cur_preset == '%a, %b %d, %Y')]}>${datetime(datetime.now().year, 12, 31, 14, 30, 47).strftime(cur_preset)}</option>
                                        % endfor
                                    </select>
                                    <select class="form-control input-sm ${(' metadataDiv', '')[not bool(sickrage.srCore.CONFIG.FUZZY_DATING)]}"
                                            id="date_presets${(' metadataDiv', '')[not bool(sickrage.srCore.CONFIG.FUZZY_DATING)]}"
                                            name="date_preset${('_na', '')[not bool(sickrage.srCore.CONFIG.FUZZY_DATING)]}">
                                        <option value="%x" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.DATE_PRESET == '%x']}>
                                            Use System Default
                                        </option>
                                        % for cur_preset in date_presets:
                                            <option value="${cur_preset}" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.DATE_PRESET == cur_preset]}>${datetime(datetime.now().year, 12, 31, 14, 30, 47).strftime(cur_preset)}</option>
                                        % endfor
                                    </select>
                                </span>
                            </label>
                                ...
                                <span class="component-desc">
                                    <select id="time_presets" name="time_preset" class="form-control input-sm">
                                         % for cur_preset in time_presets:
                                             <option value="${cur_preset}" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.TIME_PRESET_W_SECONDS == cur_preset]}>${srDateTime.now().srftime(show_seconds=True, t_preset=cur_preset)}</option>
                                         % endfor
                                    </select>
                            ...
                            <span class="component-desc">
                                <label for="local" class="space-right">
                                    <input type="radio" name="timezone_display" id="local"
                                           value="local" ${('', 'checked="checked"')[sickrage.srCore.CONFIG.TIMEZONE_DISPLAY == "local"]} />Local
                                </label>
                                <label for="network">
                                    <input type="radio" name="timezone_display" id="network"
                                           value="network" ${('', 'checked="checked"')[sickrage.srCore.CONFIG.TIMEZONE_DISPLAY == "network"]} />Network
                                </label>
                        ...
                        <div class="field-pair">
                            <label for="download_url">
                                ...
                                <input type="text" name="download_url" id="download_url"
                                       value="${sickrage.srCore.CONFIG.DOWNLOAD_URL}" size="35" autocapitalize="off"/>
                            </label>
                            <label>
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair">
                            <label for="api_key">
                                ...
                                <span class="component-desc">
                                    <input type="text" name="api_key" id="api_key" value="${sickrage.srCore.CONFIG.API_KEY}"
                            ...
                            <label for="web_log">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="web_log"
                                           id="web_log" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.WEB_LOG)]}/>
                            ...
                            <label for="web_username">
                                ...
                                <span class="component-desc">
                                    <input type="text" name="web_username" id="web_username"
                                           value="${sickrage.srCore.CONFIG.WEB_USERNAME}" class="form-control input-sm input300"
                                           autocapitalize="off"/>
                            ...
                            <label for="web_password">
                                ...
                                <span class="component-desc">
                                    <input type="password" name="web_password" id="web_password"
                                           value="${sickrage.srCore.CONFIG.WEB_PASSWORD}" class="form-control input-sm input300"
                                           autocapitalize="off"/>
                        ...
                        <div class="field-pair">
                            <label for="web_port">
                                ...
                                <span class="component-desc">
                                    <input type="text" name="web_port" id="web_port" value="${sickrage.srCore.CONFIG.WEB_PORT}"
                            ...
                            <label for="web_ipv6">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="web_ipv6"
                                           id="web_ipv6" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.WEB_IPV6)]}/>
                            ...
                            <label for="enable_https">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="enable_https" class="enabler"
                                           id="enable_https" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.ENABLE_HTTPS)]}/>
                        ...
                        <div id="content_enable_https">
                                ...
                                <label for="https_cert">
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="https_cert" id="https_cert"
                                               value="${sickrage.srCore.CONFIG.HTTPS_CERT}" class="form-control input-sm input300"
                                               autocapitalize="off"/>
                            ...
                            <div class="field-pair">
                                <label for="https_key">
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="https_key" id="https_key" value="${sickrage.srCore.CONFIG.HTTPS_KEY}"
                            ...
                            <label for="handle_reverse_proxy">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="handle_reverse_proxy"
                                           id="handle_reverse_proxy" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.HANDLE_REVERSE_PROXY)]}/>
                    ...
                    <fieldset class="component-group-list">
                            ...
                            <label>
                                ...
                                <span class="component-desc">
                                    ...
                                    % for cur_preset in cpu_presets:
                                        <option value="${cur_preset}" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.CPU_PRESET == cur_preset]}>${cur_preset.capitalize()}</option>
                                    % endfor
                                    </select>
                        ...
                        <div class="field-pair">
                            <label>
                                ...
                                <span class="component-desc">
                                    <input type="text" name="anon_redirect" value="${sickrage.srCore.CONFIG.ANON_REDIRECT}"
                                           class="form-control input-sm input300" autocapitalize="off"/>
                            ...
                            <label for="debug">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="debug"
                                           id="debug" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.DEBUG)]}/>
                                ...
                                <span class="component-title">Verify SSL Certs</span>
                                    <span class="component-desc">
                                        <input type="checkbox" name="ssl_verify"
                                               id="ssl_verify" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.SSL_VERIFY)]}/>
                            ...
                            <label for="no_restart">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="no_restart"
                                           id="no_restart" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.NO_RESTART)]}/>
                            ...
                            <label for="encryption_version">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="encryption_version"
                                           id="encryption_version" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.ENCRYPTION_VERSION)]}/>
                                    <p>in the <code>sickrage.srCore.CONFIG.ini</code> file.
                            ...
                            <label for="calendar_unprotected">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="calendar_unprotected"
                                           id="calendar_unprotected" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.CALENDAR_UNPROTECTED)]}/>
                            ...
                            <label for="calendar_icons">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="calendar_icons"
                                           id="calendar_icons" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.CALENDAR_ICONS)]}/>
                        ...
                        <div class="field-pair">
                            <label>
                                ...
                                <span class="component-desc">
                                    <input type="text" name="proxy_setting" value="${sickrage.srCore.CONFIG.PROXY_SETTING}"
                                           class="form-control input-sm input300" autocapitalize="off"/>
                            ...
                            <label for="proxy_indexers">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="proxy_indexers"
                                           id="proxy_indexers" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.PROXY_INDEXERS)]}/>
                            ...
                            <label for="skip_removed_files">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="skip_removed_files"
                                           id="skip_removed_files" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.SKIP_REMOVED_FILES)]}/>
...
% if not sickrage.srCore.CONFIG.SKIP_REMOVED_FILES:
                                        ...
                                        % for defStatus in [SKIPPED, IGNORED, ARCHIVED]:
                                            <option value="${defStatus}" ${('', 'selected="selected"')[int(sickrage.srCore.CONFIG.EP_DEFAULT_DELETED_STATUS) == defStatus]}>${statusStrings[defStatus]}</option>
                                        % endfor
                                        </select>
% else:
                                        ...
                                        % for defStatus in [SKIPPED, IGNORED]:
                                            <option value="${defStatus}" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.EP_DEFAULT_DELETED_STATUS == defStatus]}>${statusStrings[defStatus]}</option>
                                        % endfor
                                        </select>
                                        <input type="hidden" name="ep_default_deleted_status"
                                               value="${sickrage.srCore.CONFIG.EP_DEFAULT_DELETED_STATUS}"/>
% endif
                    ...
                    <fieldset class="component-group-list">
                                    ...
                                    <select id="branchVersion" class="form-control form-control-inline input-sm pull-left">
                                        ...
                                        % if gh_branch:
                                            % for cur_branch in gh_branch:
                                                % if sickrage.srCore.CONFIG.GIT_USERNAME and sickrage.srCore.CONFIG.GIT_PASSWORD and sickrage.srCore.CONFIG.DEVELOPER == 1:
                                                    <option value="${cur_branch}" ${('', 'selected="selected"')[sickrage.srCore.VERSION == cur_branch]}>${cur_branch}</option>
                                                % elif sickrage.srCore.CONFIG.GIT_USERNAME and sickrage.srCore.CONFIG.GIT_PASSWORD and cur_branch in ['master', 'develop']:
                                                    <option value="${cur_branch}" ${('', 'selected="selected"')[sickrage.srCore.VERSION == cur_branch]}>${cur_branch}</option>
                            ...
                            <label for="git_username">
                                ...
                                <span class="component-desc">
                                    <input type="text" name="git_username" id="git_username"
                                           value="${sickrage.srCore.CONFIG.GIT_USERNAME}" class="form-control input-sm input300"
                                           autocapitalize="off"/>
                            ...
                            <label for="git_password">
                                ...
                                <span class="component-desc">
                                    <input type="password" name="git_password" id="git_password"
                                           value="${sickrage.srCore.CONFIG.GIT_PASSWORD}" class="form-control input-sm input300"
                                           autocapitalize="off"/>
                                    <div class="clear-left"><p>*** (REQUIRED FOR SUBMITTING ISSUES) ***</p></div>
                                </span>
                            </label>
                        ...
                        <div class="field-pair">
                            <label for="git_remote">
                                ...
                                <span class="component-desc">
                                    <input type="text" name="git_remote" id="git_remote" value="${sickrage.srCore.CONFIG.GIT_REMOTE}"
                                           class="form-control input-sm input300" autocapitalize="off"/>
                        ...
                        <div class="field-pair">
                            <label>
                                ...
                                <span class="component-desc">
                                    <input type="text" name="git_path" value="${sickrage.srCore.CONFIG.GIT_PATH}"
                                           class="form-control input-sm input300" autocapitalize="off"/>
                            ...
                            <label for="git_reset">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="git_reset"
                                           id="git_reset" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.GIT_RESET)]}/>
                            ...
                            <label for="git_autoissues">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="git_autoissues"
                                           id="git_autoissues" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.GIT_AUTOISSUES)]}
                                           disable/>

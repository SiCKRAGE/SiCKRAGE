                            ...
                            <label class="clearfix" for="use_kodi">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_kodi"
                                           id="use_kodi" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_KODI)]}/>
                        ...
                        <div id="content_use_kodi">
                                ...
                                <label for="kodi_always_on">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="kodi_always_on"
                                               id="kodi_always_on" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.KODI_ALWAYS_ON)]}/>
                                ...
                                <label for="kodi_notify_onsnatch">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="kodi_notify_onsnatch"
                                               id="kodi_notify_onsnatch" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.KODI_NOTIFY_ONSNATCH)]}/>
                                ...
                                <label for="kodi_notify_ondownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="kodi_notify_ondownload"
                                               id="kodi_notify_ondownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.KODI_NOTIFY_ONDOWNLOAD)]}/>
                                ...
                                <label for="kodi_notify_onsubtitledownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="kodi_notify_onsubtitledownload"
                                               id="kodi_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.KODI_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                                ...
                                <label for="kodi_update_library">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="kodi_update_library"
                                               id="kodi_update_library" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.KODI_UPDATE_LIBRARY)]}/>
                                ...
                                <label for="kodi_update_full">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="kodi_update_full"
                                               id="kodi_update_full" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.KODI_UPDATE_FULL)]}/>
                                ...
                                <label for="kodi_update_onlyfirst">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="kodi_update_onlyfirst"
                                               id="kodi_update_onlyfirst" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.KODI_UPDATE_ONLYFIRST)]}/>
                            ...
                            <div class="field-pair">
                                <label for="kodi_host">
                                    ...
                                    <input type="text" name="kodi_host" id="kodi_host" value="${sickrage.srCore.CONFIG.KODI_HOST}"
                            ...
                            <div class="field-pair">
                                <label for="kodi_username">
                                    ...
                                    <input type="text" name="kodi_username" id="kodi_username"
                                           value="${sickrage.srCore.CONFIG.KODI_USERNAME}" class="form-control input-sm input250"
                                           autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <div class="field-pair">
                                <label for="kodi_password">
                                    ...
                                    <input type="password" name="kodi_password" id="kodi_password"
                                           value="${sickrage.srCore.CONFIG.KODI_PASSWORD}" class="form-control input-sm input250"
                                           autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <label for="use_plex">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_plex"
                                           id="use_plex" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_PLEX)]}/>
                            ...
                            <div class="field-pair">
                                <label for="plex_server_token">
                                    ...
                                    <input type="text" name="plex_server_token" id="plex_server_token"
                                           value="${sickrage.srCore.CONFIG.PLEX_SERVER_TOKEN}" class="form-control input-sm input250"
                                           autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                                    ...
                                    <label for="plex_username">
                                        ...
                                        <span class="component-desc">
                                            <input type="text" name="plex_username" id="plex_username"
                                                   value="${sickrage.srCore.CONFIG.PLEX_USERNAME}"
                                    ...
                                    <label for="plex_password">
                                        ...
                                        <span class="component-desc">
                                            <input type="password" name="plex_password" id="plex_password"
                                                   value="${'*' * len(sickrage.srCore.CONFIG.PLEX_PASSWORD)}"
                                                   class="form-control input-sm input250" autocapitalize="off"/>
                                            <p>blank = no authentication</p>
                                        </span>
                                    </label>
                                    ...
                                    <label for="plex_update_library">
                                        ...
                                        <span class="component-desc">
                                            <input type="checkbox" class="enabler" name="plex_update_library"
                                                   id="plex_update_library" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.PLEX_UPDATE_LIBRARY)]}/>
                                        ...
                                        <label for="plex_server_host">
                                            ...
                                            <span class="component-desc">
                                                <input type="text" name="plex_server_host" id="plex_server_host"
                                                       value="${re.sub(r'\b,\b', ', ', sickrage.srCore.CONFIG.PLEX_SERVER_HOST)}"
                                                       class="form-control input-sm input350" autocapitalize="off"/>
                    ...
                    <fieldset class="component-group-list">
                        <div class="field-pair">
                            <label for="use_plex_client">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_plex"
                                           id="use_plex_client" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_PLEX_CLIENT)]}/>
                                    <p>should SickRage send Plex commands ?</p>
                                </span>
                            </label>
                        </div>
                        ...
                        <div id="content_use_plex_client">
                                ...
                                <label for="plex_notify_onsnatch">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="plex_notify_onsnatch"
                                               id="plex_notify_onsnatch" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.PLEX_NOTIFY_ONSNATCH)]}/>
                                        <p>send a notification when a download starts ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="plex_notify_ondownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="plex_notify_ondownload"
                                               id="plex_notify_ondownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.PLEX_NOTIFY_ONDOWNLOAD)]}/>
                                        <p>send a notification when a download finishes ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="plex_notify_onsubtitledownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="plex_notify_onsubtitledownload"
                                               id="plex_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.PLEX_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                                        <p>send a notification when subtitles are downloaded ?</p>
                                    </span>
                                </label>
                            </div>
                            <div class="field-pair">
                                <label for="plex_host">
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="plex_host" id="plex_host" value="${sickrage.srCore.CONFIG.PLEX_HOST}"
                                               class="form-control input-sm input350" autocapitalize="off"/>
                                        <div class="clear-left">
                                    ...
                                    <label for="plex_username">
                                        ...
                                        <span class="component-desc">
                                            <input type="text" name="plex_client_username" id="plex_client_username"
                                                   value="${sickrage.srCore.CONFIG.PLEX_CLIENT_USERNAME}"
                                                   class="form-control input-sm input250" autocapitalize="off"/>
                                            <p>blank = no authentication</p>
                                        </span>
                                    </label>
                                    ...
                                    <label for="plex_client_password">
                                        ...
                                        <span class="component-desc">
                                            <input type="password" name="plex_client_password" id="plex_client_password"
                                                   value="${'*' * len(sickrage.srCore.CONFIG.PLEX_CLIENT_PASSWORD)}"
                                                   class="form-control input-sm input250" autocapitalize="off"/>
                                            <p>blank = no authentication</p>
                                        </span>
                                    </label>
                            ...
                            <label for="use_emby">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_emby"
                                           id="use_emby" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_EMBY)]} />
                        ...
                        <div id="content_use_emby">
                            <div class="field-pair">
                                <label for="emby_host">
                                    ...
                                    <input type="text" name="emby_host" id="emby_host" value="${sickrage.srCore.CONFIG.EMBY_HOST}"
                                           class="form-control input-sm input250" autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <div class="field-pair">
                                <label for="emby_apikey">
                                    ...
                                    <input type="text" name="emby_apikey" id="emby_apikey"
                                           value="${sickrage.srCore.CONFIG.EMBY_APIKEY}" class="form-control input-sm input250"
                                           autocapitalize="off"/>
                                </label>
                            </div>
                            ...
                            <label for="use_nmj">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_nmj"
                                           id="use_nmj" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_NMJ)]}/>
                        ...
                        <div id="content_use_nmj">
                            <div class="field-pair">
                                <label for="nmj_host">
                                    ...
                                    <input type="text" name="nmj_host" id="nmj_host" value="${sickrage.srCore.CONFIG.NMJ_HOST}"
                                           class="form-control input-sm input250" autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <div class="field-pair">
                                <label for="nmj_database">
                                    ...
                                    <input type="text" name="nmj_database" id="nmj_database"
                                           value="${sickrage.srCore.CONFIG.NMJ_DATABASE}" class="form-control input-sm input250"
                                           autocapitalize="off" ${(' readonly="readonly"', '')[sickrage.srCore.CONFIG.NMJ_DATABASE == True]}/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <div class="field-pair">
                                <label for="nmj_mount">
                                    ...
                                    <input type="text" name="nmj_mount" id="nmj_mount" value="${sickrage.srCore.CONFIG.NMJ_MOUNT}"
                                           class="form-control input-sm input250"
                                           autocapitalize="off" ${(' readonly="readonly"', '')[sickrage.srCore.CONFIG.NMJ_MOUNT == True]}/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                                    <span class="component-desc">automatically filled via the 'Get Settings' button.</span>
                            ...
                            <label for="use_nmjv2">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_nmjv2"
                                           id="use_nmjv2" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_NMJv2)]}/>
                        ...
                        <div id="content_use_nmjv2">
                            <div class="field-pair">
                                <label for="nmjv2_host">
                                    <span class="component-title">Popcorn IP address</span>
                                    <input type="text" name="nmjv2_host" id="nmjv2_host" value="${sickrage.srCore.CONFIG.NMJv2_HOST}"
                                           class="form-control input-sm input250" autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                                ...
                                <span class="component-desc">
                                    <label for="NMJV2_DBLOC_A" class="space-right">
                                        <input type="radio" NAME="nmjv2_dbloc" VALUE="local"
                                               id="NMJV2_DBLOC_A" ${('', 'checked="checked"')[sickrage.srCore.CONFIG.NMJv2_DBLOC == 'local']}/>PCH
                                        Local Media
                                    </label>
                                    <label for="NMJV2_DBLOC_B">
                                        <input type="radio" NAME="nmjv2_dbloc" VALUE="network"
                                               id="NMJV2_DBLOC_B" ${('', 'checked="checked"')[sickrage.srCore.CONFIG.NMJv2_DBLOC == 'network']}/>PCH
                                        Network Media
                                    </label>
                                </span>
                            </div>
                            ...
                            <div class="field-pair">
                                <label for="nmjv2_database">
                                    ...
                                    <input type="text" name="nmjv2_database" id="nmjv2_database"
                                           value="${sickrage.srCore.CONFIG.NMJv2_DATABASE}" class="form-control input-sm input250"
                                           autocapitalize="off" ${(' readonly="readonly"', '')[sickrage.srCore.CONFIG.NMJv2_DATABASE == True]}/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <label for="use_synoindex">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_synoindex"
                                           id="use_synoindex" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_SYNOINDEX)]}/>
                            ...
                            <label for="use_synologynotifier">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_synologynotifier"
                                           id="use_synologynotifier" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_SYNOLOGYNOTIFIER)]}/>
                                ...
                                <label for="synologynotifier_notify_onsnatch">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="synologynotifier_notify_onsnatch"
                                               id="synologynotifier_notify_onsnatch" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.SYNOLOGYNOTIFIER_NOTIFY_ONSNATCH)]}/>
                                        <p>send a notification when a download starts ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="synologynotifier_notify_ondownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="synologynotifier_notify_ondownload"
                                               id="synologynotifier_notify_ondownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.SYNOLOGYNOTIFIER_NOTIFY_ONDOWNLOAD)]}/>
                                        <p>send a notification when a download finishes ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="synologynotifier_notify_onsubtitledownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="synologynotifier_notify_onsubtitledownload"
                                               id="synologynotifier_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.SYNOLOGYNOTIFIER_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                                        <p>send a notification when subtitles are downloaded ?</p>
                                    </span>
                                </label>
                            </div>
                            ...
                            <label for="use_pytivo">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_pytivo"
                                           id="use_pytivo" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_PYTIVO)]}/>
                            ...
                            <div class="field-pair">
                                <label for="pytivo_host">
                                    ...
                                    <input type="text" name="pytivo_host" id="pytivo_host"
                                           value="${sickrage.srCore.CONFIG.PYTIVO_HOST}" class="form-control input-sm input250"
                                           autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <div class="field-pair">
                                <label for="pytivo_share_name">
                                    ...
                                    <input type="text" name="pytivo_share_name" id="pytivo_share_name"
                                           value="${sickrage.srCore.CONFIG.PYTIVO_SHARE_NAME}" class="form-control input-sm input250"
                                           autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <div class="field-pair">
                                <label for="pytivo_tivo_name">
                                    ...
                                    <input type="text" name="pytivo_tivo_name" id="pytivo_tivo_name"
                                           value="${sickrage.srCore.CONFIG.PYTIVO_TIVO_NAME}" class="form-control input-sm input250"
                                           autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <label for="use_growl">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_growl"
                                           id="use_growl" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_GROWL)]}/>
                        ...
                        <div id="content_use_growl">
                                ...
                                <label for="growl_notify_onsnatch">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="growl_notify_onsnatch"
                                               id="growl_notify_onsnatch" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.GROWL_NOTIFY_ONSNATCH)]}/>
                                        <p>send a notification when a download starts ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="growl_notify_ondownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="growl_notify_ondownload"
                                               id="growl_notify_ondownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.GROWL_NOTIFY_ONDOWNLOAD)]}/>
                                        <p>send a notification when a download finishes ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="growl_notify_onsubtitledownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="growl_notify_onsubtitledownload"
                                               id="growl_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.GROWL_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                                        <p>send a notification when subtitles are downloaded ?</p>
                                    </span>
                                </label>
                            </div>
                            <div class="field-pair">
                                <label for="growl_host">
                                    ...
                                    <input type="text" name="growl_host" id="growl_host" value="${sickrage.srCore.CONFIG.GROWL_HOST}"
                                           class="form-control input-sm input250" autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <div class="field-pair">
                                <label for="growl_password">
                                    ...
                                    <input type="password" name="growl_password" id="growl_password"
                                           value="${sickrage.srCore.CONFIG.GROWL_PASSWORD}" class="form-control input-sm input250"
                                           autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <label for="use_prowl">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_prowl"
                                           id="use_prowl" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_PROWL)]}/>
                        ...
                        <div id="content_use_prowl">
                                ...
                                <label for="prowl_notify_onsnatch">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="prowl_notify_onsnatch"
                                               id="prowl_notify_onsnatch" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.PROWL_NOTIFY_ONSNATCH)]}/>
                                        <p>send a notification when a download starts ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="prowl_notify_ondownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="prowl_notify_ondownload"
                                               id="prowl_notify_ondownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.PROWL_NOTIFY_ONDOWNLOAD)]}/>
                                        <p>send a notification when a download finishes ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="prowl_notify_onsubtitledownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="prowl_notify_onsubtitledownload"
                                               id="prowl_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.PROWL_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                                        <p>send a notification when subtitles are downloaded ?</p>
                                    </span>
                                </label>
                            </div>
                            <div class="field-pair">
                                <label for="prowl_api">
                                    ...
                                    <input type="text" name="prowl_api" id="prowl_api" value="${sickrage.srCore.CONFIG.PROWL_API}"
                                           class="form-control input-sm input250" autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <div class="field-pair">
                                <label for="prowl_priority">
                                    ...
                                    <select id="prowl_priority" name="prowl_priority" class="form-control input-sm">
                                        <option value="-2" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PROWL_PRIORITY == '-2']}>
                                            Very Low
                                        </option>
                                        <option value="-1" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PROWL_PRIORITY == '-1']}>
                                            Moderate
                                        </option>
                                        <option value="0" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PROWL_PRIORITY == '0']}>
                                            Normal
                                        </option>
                                        <option value="1" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PROWL_PRIORITY == '1']}>
                                            High
                            ...
                            <label for="use_libnotify">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_libnotify"
                                           id="use_libnotify" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_LIBNOTIFY)]}/>
                                ...
                                <label for="libnotify_notify_onsnatch">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="libnotify_notify_onsnatch"
                                               id="libnotify_notify_onsnatch" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.LIBNOTIFY_NOTIFY_ONSNATCH)]}/>
                                        <p>send a notification when a download starts ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="libnotify_notify_ondownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="libnotify_notify_ondownload"
                                               id="libnotify_notify_ondownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.LIBNOTIFY_NOTIFY_ONDOWNLOAD)]}/>
                                        <p>send a notification when a download finishes ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="libnotify_notify_onsubtitledownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="libnotify_notify_onsubtitledownload"
                                               id="libnotify_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.LIBNOTIFY_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                                        <p>send a notification when subtitles are downloaded ?</p>
                                    </span>
                                </label>
                            </div>
                            ...
                            <label for="use_pushover">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_pushover"
                                           id="use_pushover" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_PUSHOVER)]}/>
                                ...
                                <label for="pushover_notify_onsnatch">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="pushover_notify_onsnatch"
                                               id="pushover_notify_onsnatch" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.PUSHOVER_NOTIFY_ONSNATCH)]}/>
                                        <p>send a notification when a download starts ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="pushover_notify_ondownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="pushover_notify_ondownload"
                                               id="pushover_notify_ondownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.PUSHOVER_NOTIFY_ONDOWNLOAD)]}/>
                                        <p>send a notification when a download finishes ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="pushover_notify_onsubtitledownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="pushover_notify_onsubtitledownload"
                                               id="pushover_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.PUSHOVER_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                                        <p>send a notification when subtitles are downloaded ?</p>
                                    </span>
                                </label>
                            </div>
                            <div class="field-pair">
                                <label for="pushover_userkey">
                                    ...
                                    <input type="text" name="pushover_userkey" id="pushover_userkey"
                                           value="${sickrage.srCore.CONFIG.PUSHOVER_USERKEY}" class="form-control input-sm input250"
                                           autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <div class="field-pair">
                                <label for="pushover_apikey">
                                    ...
                                    <input type="text" name="pushover_apikey" id="pushover_apikey"
                                           value="${sickrage.srCore.CONFIG.PUSHOVER_APIKEY}" class="form-control input-sm input250"
                                           autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <div class="field-pair">
                                <label for="pushover_device">
                                    ...
                                    <input type="text" name="pushover_device" id="pushover_device"
                                           value="${sickrage.srCore.CONFIG.PUSHOVER_DEVICE}" class="form-control input-sm input250"
                                           autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <div class="field-pair">
                                <label for="pushover_sound">
                                    ...
                                    <select id="pushover_sound" name="pushover_sound" class="form-control input-sm">
                                        <option value="pushover" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'pushover']}>
                                            Pushover
                                        </option>
                                        <option value="bike" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'bike']}>
                                            Bike
                                        </option>
                                        <option value="bugle" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'bugle']}>
                                            Bugle
                                        </option>
                                        <option value="cashregister" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'cashregister']}>
                                            Cash Register
                                        </option>
                                        <option value="classical" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'classical']}>
                                            Classical
                                        </option>
                                        <option value="cosmic" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'cosmic']}>
                                            Cosmic
                                        </option>
                                        <option value="falling" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'falling']}>
                                            Falling
                                        </option>
                                        <option value="gamelan" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'gamelan']}>
                                            Gamelan
                                        </option>
                                        <option value="incoming" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'incoming']}>
                                            Incoming
                                        </option>
                                        <option value="intermission" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'intermission']}>
                                            Intermission
                                        </option>
                                        <option value="magic" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'magic']}>
                                            Magic
                                        </option>
                                        <option value="mechanical" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'mechanical']}>
                                            Mechanical
                                        </option>
                                        <option value="pianobar" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'pianobar']}>
                                            Piano Bar
                                        </option>
                                        <option value="siren" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'siren']}>
                                            Siren
                                        </option>
                                        <option value="spacealarm" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'spacealarm']}>
                                            Space Alarm
                                        </option>
                                        <option value="tugboat" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'tugboat']}>
                                            Tug Boat
                                        </option>
                                        <option value="alien" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'alien']}>
                                            Alien Alarm (long)
                                        </option>
                                        <option value="climb" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'climb']}>
                                            Climb (long)
                                        </option>
                                        <option value="persistent" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'persistent']}>
                                            Persistent (long)
                                        </option>
                                        <option value="echo" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'echo']}>
                                            Pushover Echo (long)
                                        </option>
                                        <option value="updown" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'updown']}>
                                            Up Down (long)
                                        </option>
                                        <option value="none" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'none']}>
                                            None (silent)
                                        </option>
                                        <option value="default" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PUSHOVER_SOUND == 'default']}>
                                            Device specific
                                        </option>
                                    </select>
                                </label>
                            ...
                            <label for="use_boxcar">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_boxcar"
                                           id="use_boxcar" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_BOXCAR)]}/>
                                ...
                                <label for="boxcar_notify_onsnatch">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="boxcar_notify_onsnatch"
                                               id="boxcar_notify_onsnatch" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.BOXCAR_NOTIFY_ONSNATCH)]}/>
                                        <p>send a notification when a download starts ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="boxcar_notify_ondownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="boxcar_notify_ondownload"
                                               id="boxcar_notify_ondownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.BOXCAR_NOTIFY_ONDOWNLOAD)]}/>
                                        <p>send a notification when a download finishes ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="boxcar_notify_onsubtitledownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="boxcar_notify_onsubtitledownload"
                                               id="boxcar_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.BOXCAR_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                                        <p>send a notification when subtitles are downloaded ?</p>
                                    </span>
                                </label>
                            </div>
                            <div class="field-pair">
                                <label for="boxcar_username">
                                    ...
                                    <input type="text" name="boxcar_username" id="boxcar_username"
                                           value="${sickrage.srCore.CONFIG.BOXCAR_USERNAME}" class="form-control input-sm input250"
                                           autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <label for="use_boxcar2">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_boxcar2"
                                           id="use_boxcar2" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_BOXCAR2)]}/>
                                ...
                                <label for="boxcar2_notify_onsnatch">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="boxcar2_notify_onsnatch"
                                               id="boxcar2_notify_onsnatch" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.BOXCAR2_NOTIFY_ONSNATCH)]}/>
                                        <p>send a notification when a download starts ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="boxcar2_notify_ondownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="boxcar2_notify_ondownload"
                                               id="boxcar2_notify_ondownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.BOXCAR2_NOTIFY_ONDOWNLOAD)]}/>
                                        <p>send a notification when a download finishes ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="boxcar2_notify_onsubtitledownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="boxcar2_notify_onsubtitledownload"
                                               id="boxcar2_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.BOXCAR2_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                                        <p>send a notification when subtitles are downloaded ?</p>
                                    </span>
                                </label>
                            </div>
                            <div class="field-pair">
                                <label for="boxcar2_accesstoken">
                                    ...
                                    <input type="text" name="boxcar2_accesstoken" id="boxcar2_accesstoken"
                                           value="${sickrage.srCore.CONFIG.BOXCAR2_ACCESSTOKEN}"
                                           class="form-control input-sm input250" autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <label for="use_nma">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_nma"
                                           id="use_nma" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_NMA)]}/>
                        ...
                        <div id="content_use_nma">
                                ...
                                <label for="nma_notify_onsnatch">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="nma_notify_onsnatch"
                                               id="nma_notify_onsnatch" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.NMA_NOTIFY_ONSNATCH)]}/>
                                        <p>send a notification when a download starts ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="nma_notify_ondownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="nma_notify_ondownload"
                                               id="nma_notify_ondownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.NMA_NOTIFY_ONDOWNLOAD)]}/>
                                        <p>send a notification when a download finishes ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="nma_notify_onsubtitledownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="nma_notify_onsubtitledownload"
                                               id="nma_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.NMA_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                                        <p>send a notification when subtitles are downloaded ?</p>
                                    </span>
                                </label>
                            </div>
                            <div class="field-pair">
                                <label for="nma_api">
                                    ...
                                    <input type="text" name="nma_api" id="nma_api" value="${sickrage.srCore.CONFIG.NMA_API}"
                                           class="form-control input-sm input350" autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                                ...
                                <label for="nma_priority">
                                    <span class="component-title">NMA priority:</span>
                                       <select id="nma_priority" name="nma_priority" class="form-control input-sm">
                                           <option value="-2" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.NMA_PRIORITY == '-2']}>
                                               Very Low
                                           </option>
                                           <option value="-1" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.NMA_PRIORITY == '-1']}>
                                               Moderate
                                           </option>
                                           <option value="0" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.NMA_PRIORITY == '0']}>
                                               Normal
                                           </option>
                                           <option value="1" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.NMA_PRIORITY == '1']}>
                                               High
                            ...
                            <label for="use_pushalot">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_pushalot"
                                           id="use_pushalot" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_PUSHALOT)]}/>
                                ...
                                <label for="pushalot_notify_onsnatch">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="pushalot_notify_onsnatch"
                                               id="pushalot_notify_onsnatch" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.PUSHALOT_NOTIFY_ONSNATCH)]}/>
                                        <p>send a notification when a download starts ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="pushalot_notify_ondownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="pushalot_notify_ondownload"
                                               id="pushalot_notify_ondownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.PUSHALOT_NOTIFY_ONDOWNLOAD)]}/>
                                        <p>send a notification when a download finishes ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="pushalot_notify_onsubtitledownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="pushalot_notify_onsubtitledownload"
                                               id="pushalot_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.PUSHALOT_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                                        <p>send a notification when subtitles are downloaded ?</p>
                                    </span>
                                </label>
                            </div>
                            <div class="field-pair">
                                <label for="pushalot_authorizationtoken">
                                    ...
                                    <input type="text" name="pushalot_authorizationtoken"
                                           ...
                                           value="${sickrage.srCore.CONFIG.PUSHALOT_AUTHORIZATIONTOKEN}"
                                           class="form-control input-sm input350" autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <label for="use_pushbullet">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_pushbullet"
                                           id="use_pushbullet" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_PUSHBULLET)]}/>
                        ...
                        <div id="content_use_pushbullet">
                                ...
                                <label for="pushbullet_notify_onsnatch">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="pushbullet_notify_onsnatch"
                                               id="pushbullet_notify_onsnatch" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.PUSHBULLET_NOTIFY_ONSNATCH)]}/>
                                        <p>send a notification when a download starts ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="pushbullet_notify_ondownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="pushbullet_notify_ondownload"
                                               id="pushbullet_notify_ondownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.PUSHBULLET_NOTIFY_ONDOWNLOAD)]}/>
                                        <p>send a notification when a download finishes ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="pushbullet_notify_onsubtitledownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="pushbullet_notify_onsubtitledownload"
                                               id="pushbullet_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.PUSHBULLET_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                                        <p>send a notification when subtitles are downloaded ?</p>
                                    </span>
                                </label>
                            </div>
                            <div class="field-pair">
                                <label for="pushbullet_api">
                                    ...
                                    <input type="text" name="pushbullet_api" id="pushbullet_api"
                                           value="${sickrage.srCore.CONFIG.PUSHBULLET_API}" class="form-control input-sm input350"
                                           autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <div class="field-pair">
                                <label for="pushbullet_device_list">
                                    ...
                                    <input type="hidden" id="pushbullet_device" value="${sickrage.srCore.CONFIG.PUSHBULLET_DEVICE}">
                            ...
                            <label for="use_freemobile">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_freemobile"
                                           id="use_freemobile" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_FREEMOBILE)]}/>
                                ...
                                <label for="freemobile_notify_onsnatch">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="freemobile_notify_onsnatch"
                                               id="freemobile_notify_onsnatch" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.FREEMOBILE_NOTIFY_ONSNATCH)]}/>
                                ...
                                <label for="freemobile_notify_ondownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="freemobile_notify_ondownload"
                                               id="freemobile_notify_ondownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.FREEMOBILE_NOTIFY_ONDOWNLOAD)]}/>
                                ...
                                <label for="freemobile_notify_onsubtitledownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="freemobile_notify_onsubtitledownload"
                                               id="freemobile_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.FREEMOBILE_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                            ...
                            <div class="field-pair">
                                <label for="freemobile_id">
                                    ...
                                    <input type="text" name="freemobile_id" id="freemobile_id"
                                           value="${sickrage.srCore.CONFIG.FREEMOBILE_ID}" class="form-control input-sm input250"
                                           autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <div class="field-pair">
                                <label for="freemobile_password">
                                    ...
                                    <input type="text" name="freemobile_apikey" id="freemobile_apikey"
                                           value="${sickrage.srCore.CONFIG.FREEMOBILE_APIKEY}" class="form-control input-sm input250"
                                           autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <label for="use_twitter">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_twitter"
                                           id="use_twitter" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_TWITTER)]}/>
                                ...
                                <label for="twitter_notify_onsnatch">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="twitter_notify_onsnatch"
                                               id="twitter_notify_onsnatch" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.TWITTER_NOTIFY_ONSNATCH)]}/>
                                        <p>send a notification when a download starts ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="twitter_notify_ondownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="twitter_notify_ondownload"
                                               id="twitter_notify_ondownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.TWITTER_NOTIFY_ONDOWNLOAD)]}/>
                                        <p>send a notification when a download finishes ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="twitter_notify_onsubtitledownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="twitter_notify_onsubtitledownload"
                                               id="twitter_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.TWITTER_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                                        <p>send a notification when subtitles are downloaded ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="twitter_usedm">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="twitter_usedm"
                                               id="twitter_usedm" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.TWITTER_USEDM)]}/>
                            ...
                            <div class="field-pair">
                                <label for="twitter_dmto">
                                    ...
                                    <input type="text" name="twitter_dmto" id="twitter_dmto"
                                           value="${sickrage.srCore.CONFIG.TWITTER_DMTO}" class="form-control input-sm input250"
                                           autocapitalize="off"/>
                                </label>
                                <p>
                ...
                <div class="component-group">
                    ...
                    <fieldset class="component-group-list">
                            ...
                            <label for="use_trakt">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_trakt"
                                           id="use_trakt" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_TRAKT)]}/>
                        ...
                        <div id="content_use_trakt">
                            <div class="field-pair">
                                <label for="trakt_username">
                                    ...
                                    <input type="text" name="trakt_username" id="trakt_username"
                                           value="${sickrage.srCore.CONFIG.TRAKT_USERNAME}" class="form-control input-sm input250"
                                           autocapitalize="off"/>
                                </label>
                                <p>
                            ...
                            <input type="hidden" id="trakt_pin_url" value="${sickrage.srCore.CONFIG.TRAKT_PIN_URL}">
                            <input type="button" class="btn ${('', 'hide')[bool(sickrage.srCore.CONFIG.TRAKT_ACCESS_TOKEN)]}"
                            ...
                            <div class="field-pair">
                                <label for="trakt_timeout">
                                    ...
                                    <input type="text" name="trakt_timeout" id="trakt_timeout"
                                           value="${sickrage.srCore.CONFIG.TRAKT_TIMEOUT}" class="form-control input-sm input75"/>
                                </label>
                                <p>
                                    <span class="component-desc">
                                    ...
                                    <span class="component-desc">
                                        <select id="trakt_default_indexer" name="trakt_default_indexer" class="form-control input-sm">
                                            % for indexer in sickrage.srCore.INDEXER_API().indexers:
                                                <option value="${indexer}" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.TRAKT_DEFAULT_INDEXER == indexer]}>${sickrage.srCore.INDEXER_API().indexers[indexer]}</option>
                                            % endfor
                                        </select>
                                    </span>
                                </label>
                                ...
                                <label for="trakt_sync">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" class="enabler" name="trakt_sync"
                                               id="trakt_sync" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.TRAKT_SYNC)]}/>
                                    ...
                                    <label for="trakt_sync_remove">
                                        ...
                                        <span class="component-desc">
                                            <input type="checkbox" name="trakt_sync_remove"
                                                   id="trakt_sync_remove" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.TRAKT_SYNC_REMOVE)]}/>
                                ...
                                <label for="trakt_sync_watchlist">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" class="enabler" name="trakt_sync_watchlist"
                                               id="trakt_sync_watchlist" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.TRAKT_SYNC_WATCHLIST)]}/>
                                    ...
                                    <label for="trakt_method_add">
                                        <span class="component-title">Watchlist add method</span>
                                           <select id="trakt_method_add" name="trakt_method_add" class="form-control input-sm">
                                               <option value="0" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.TRAKT_METHOD_ADD == 0]}>
                                                   Skip All
                                               </option>
                                               <option value="1" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.TRAKT_METHOD_ADD == 1]}>
                                                   Download Pilot Only
                                               </option>
                                               <option value="2" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.TRAKT_METHOD_ADD == 2]}>
                                                   Get whole show
                                               </option>
                                        </select>
                                    </label>
                                    ...
                                    <label for="trakt_remove_watchlist">
                                        ...
                                        <span class="component-desc">
                                            <input type="checkbox" name="trakt_remove_watchlist"
                                                   id="trakt_remove_watchlist" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.TRAKT_REMOVE_WATCHLIST)]}/>
                                    ...
                                    <label for="trakt_remove_serieslist">
                                        ...
                                        <span class="component-desc">
                                            <input type="checkbox" name="trakt_remove_serieslist"
                                                   id="trakt_remove_serieslist" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.TRAKT_REMOVE_SERIESLIST)]}/>
                                    ...
                                    <label for="trakt_remove_show_from_sickrage">
                                        ...
                                        <span class="component-desc">
                                            <input type="checkbox" name="trakt_remove_show_from_sickrage"
                                                   id="trakt_remove_show_from_sickrage" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.TRAKT_REMOVE_SHOW_FROM_SICKRAGE)]}/>
                                    ...
                                    <label for="trakt_start_paused">
                                        ...
                                        <span class="component-desc">
                                            <input type="checkbox" name="trakt_start_paused"
                                                   id="trakt_start_paused" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.TRAKT_START_PAUSED)]}/>
                            ...
                            <div class="field-pair">
                                <label for="trakt_blacklist_name">
                                    ...
                                    <input type="text" name="trakt_blacklist_name" id="trakt_blacklist_name"
                                           value="${sickrage.srCore.CONFIG.TRAKT_BLACKLIST_NAME}"
                            ...
                            <label for="use_email">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" class="enabler" name="use_email"
                                           id="use_email" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.USE_EMAIL)]}/>
                        ...
                        <div id="content_use_email">
                                ...
                                <label for="email_notify_onsnatch">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="email_notify_onsnatch"
                                               id="email_notify_onsnatch" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.EMAIL_NOTIFY_ONSNATCH)]}/>
                                        <p>send a notification when a download starts ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="email_notify_ondownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="email_notify_ondownload"
                                               id="email_notify_ondownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.EMAIL_NOTIFY_ONDOWNLOAD)]}/>
                                        <p>send a notification when a download finishes ?</p>
                                    </span>
                                </label>
                            </div>
                                ...
                                <label for="email_notify_onsubtitledownload">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="email_notify_onsubtitledownload"
                                               id="email_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.EMAIL_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                                        <p>send a notification when subtitles are downloaded ?</p>
                                    </span>
                                </label>
                            </div>
                            <div class="field-pair">
                                <label for="email_host">
                                    ...
                                    <input type="text" name="email_host" id="email_host" value="${sickrage.srCore.CONFIG.EMAIL_HOST}"
                                           class="form-control input-sm input250" autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <div class="field-pair">
                                <label for="email_port">
                                    ...
                                    <input type="text" name="email_port" id="email_port" value="${sickrage.srCore.CONFIG.EMAIL_PORT}"
                            ...
                            <div class="field-pair">
                                <label for="email_from">
                                    ...
                                    <input type="text" name="email_from" id="email_from" value="${sickrage.srCore.CONFIG.EMAIL_FROM}"
                                           class="form-control input-sm input250" autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                                ...
                                <label for="email_tls">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="email_tls"
                                               id="email_tls" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.EMAIL_TLS)]}/>
                            ...
                            <div class="field-pair">
                                <label for="email_user">
                                    ...
                                    <input type="text" name="email_user" id="email_user" value="${sickrage.srCore.CONFIG.EMAIL_USER}"
                                           class="form-control input-sm input250" autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <div class="field-pair">
                                <label for="email_password">
                                    ...
                                    <input type="password" name="email_password" id="email_password"
                                           value="${sickrage.srCore.CONFIG.EMAIL_PASSWORD}" class="form-control input-sm input250"
                                           autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>
                            ...
                            <div class="field-pair">
                                <label for="email_list">
                                    ...
                                    <input type="text" name="email_list" id="email_list" value="${sickrage.srCore.CONFIG.EMAIL_LIST}"
                                           class="form-control input-sm input350" autocapitalize="off"/>
                                </label>
                                <label>
                                    <span class="component-title">&nbsp;</span>

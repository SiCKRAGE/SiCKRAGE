...
<%block name="scripts">
    ...
    <script type="text/javascript" src="${srRoot}/js/configPostProcessing.js?${srPID}"></script>
                    ...
                    <fieldset class="component-group-list">
                        <div class="field-pair">
                            <input type="checkbox" name="process_automatically"
                                   id="process_automatically" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.PROCESS_AUTOMATICALLY)]}/>
                        ...
                        <div class="field-pair">
                            <label class="nocheck" for="tv_download_dir">
                                ...
                                <input type="text" name="tv_download_dir" id="tv_download_dir"
                                       value="${sickrage.srCore.CONFIG.TV_DOWNLOAD_DIR}" class="form-control input-sm input350"
                                       autocapitalize="off"/>
                            </label>
                            <label class="nocheck">
                                <span class="component-title">&nbsp;</span>
                                ...
                                <span class="component-desc">
                                    <select name="process_method" id="process_method" class="form-control input-sm">
                                        ...
                                        % for curAction in ('copy', 'move', 'hardlink', 'symlink'):
                                            <option value="${curAction}" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.PROCESS_METHOD == curAction]}>${process_method_text[curAction]}</option>
                                        % endfor
                                    </select>
                                </span>
                            </label>
                        ...
                        <div class="field-pair">
                            <label class="nocheck">
                                ...
                                <input type="number" min="10" name="autopostprocessor_frequency"
                                       id="autopostprocessor_frequency" value="${sickrage.srCore.CONFIG.AUTOPOSTPROCESSOR_FREQ}"
                        ...
                        <div class="field-pair">
                            <input type="checkbox" name="postpone_if_sync_files"
                                   id="postpone_if_sync_files" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.POSTPONE_IF_SYNC_FILES)]}/>
                        ...
                        <div class="field-pair">
                            <label class="nocheck">
                                ...
                                <input type="text" name="sync_files" id="sync_files" value="${sickrage.srCore.CONFIG.SYNC_FILES}"
                        ...
                        <div class="field-pair">
                            <input type="checkbox" name="rename_episodes"
                                   id="rename_episodes" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.RENAME_EPISODES)]}/>
                        ...
                        <div class="field-pair">
                            <input type="checkbox" name="create_missing_show_dirs"
                                   id="create_missing_show_dirs" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.CREATE_MISSING_SHOW_DIRS)]}/>
                        ...
                        <div class="field-pair">
                            <input type="checkbox" name="add_shows_wo_dir"
                                   id="add_shows_wo_dir" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.ADD_SHOWS_WO_DIR)]}/>
                        ...
                        <div class="field-pair">
                            <input type="checkbox" name="move_associated_files"
                                   id="move_associated_files" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.MOVE_ASSOCIATED_FILES)]}/>
                        ...
                        <div class="field-pair">
                            <input type="checkbox" name="nfo_rename"
                                   id="nfo_rename" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.NFO_RENAME)]}/>
                        ...
                        <div class="field-pair">
                            <input type="checkbox" name="airdate_episodes"
                                   id="airdate_episodes" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.AIRDATE_EPISODES)]}/>
                                ...
                                <span class="component-desc">
                                    <select name="file_timestamp_timezone" id="file_timestamp_timezone" class="form-control input-sm">
                                        % for curTimezone in ('local','network'):
                                            <option value="${curTimezone}" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.FILE_TIMESTAMP_TIMEZONE == curTimezone]}>${curTimezone}</option>
                                        % endfor
                                    </select>
                                </span>
                            </label>
                        ...
                        <div class="field-pair">
                            <input id="unpack" type="checkbox"
                                   name="unpack" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.UNPACK)]} />
                            <label for="unpack">
                        ...
                        <div class="field-pair">
                            <input type="checkbox" name="del_rar_contents"
                                   id="del_rar_contents" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.DELRARCONTENTS)]}/>
                        ...
                        <div class="field-pair">
                            <input type="checkbox" name="no_delete"
                                   id="no_delete" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.NO_DELETE)]}/>
                            <label for="no_delete">
                        ...
                        <div class="field-pair">
                            <label class="nocheck">
                                ...
                                <input type="text" name="extra_scripts" value="${'|'.join(sickrage.srCore.CONFIG.EXTRA_SCRIPTS)}"
                                       class="form-control input-sm input350" autocapitalize="off"/>
                            </label>
                            <label class="nocheck">
                                <span class="component-title">&nbsp;</span>
                    ...
                    <fieldset class="component-group-list">
                                ...
                                <span class="component-desc">
                                    <select id="name_presets" class="form-control input-sm">
                                        ...
                                        % for cur_preset in validator.name_presets:
                                            ...
                                            % if cur_preset == sickrage.srCore.CONFIG.NAMING_PATTERN:
                                                <% is_custom = False %>
                                            % endif
                                                <option id="${cur_preset}" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.NAMING_PATTERN == cur_preset]}>${os.path.join(tmp[b'dir'], tmp[b'name'])}</option>
                                        % endfor
                                        <option id="${sickrage.srCore.CONFIG.NAMING_PATTERN}" ${('', 'selected="selected"')[bool(is_custom)]}>
                                            Custom...
                                        </option>
                                    </select>
                                </span>
                                ...
                                <label class="nocheck">
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="naming_pattern" id="naming_pattern"
                                               value="${sickrage.srCore.CONFIG.NAMING_PATTERN}"
                            ...
                            <label class="nocheck" for="naming_multi_ep">
                                ...
                                <span class="component-desc">
                                    ...
                                    % for cur_multi_ep in sorted(multiEpStrings.iteritems(), key=lambda x: x[1]):
                                        <option value="${cur_multi_ep[0]}" ${('', 'selected="selected"')[cur_multi_ep[0] == sickrage.srCore.CONFIG.NAMING_MULTI_EP]}>${cur_multi_ep[1]}</option>
                                    % endfor
                                    </select>
                                </span>
                            </label>
                        ...
                        <div class="field-pair">
                            <input type="checkbox" id="naming_strip_year"
                                   name="naming_strip_year" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.NAMING_STRIP_YEAR)]}/>
                        ...
                        <div class="field-pair">
                            <input type="checkbox" class="enabler" id="naming_custom_abd"
                                   name="naming_custom_abd" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.NAMING_CUSTOM_ABD)]}/>
                                    ...
                                    <span class="component-desc">
                                        <select id="name_abd_presets" class="form-control input-sm">
                                            ...
                                            % for cur_preset in validator.name_abd_presets:
                                                ...
                                                % if cur_preset == sickrage.srCore.CONFIG.NAMING_ABD_PATTERN:
                                                    <% is_abd_custom = False %>
                                                % endif
                                                    <option id="${cur_preset}" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.NAMING_ABD_PATTERN == cur_preset]}>${os.path.join(tmp[b'dir'], tmp[b'name'])}</option>
                                            % endfor
                                            <option id="${sickrage.srCore.CONFIG.NAMING_ABD_PATTERN}" ${('', 'selected="selected"')[bool(is_abd_custom)]}>
                                                Custom...
                                            </option>
                                        </select>
                                    </span>
                                    ...
                                    <label class="nocheck">
                                        ...
                                        <span class="component-desc">
                                            <input type="text" name="naming_abd_pattern" id="naming_abd_pattern"
                                                   value="${sickrage.srCore.CONFIG.NAMING_ABD_PATTERN}"
                                                   class="form-control input-sm input350"/>
                        ...
                        <div class="field-pair">
                            <input type="checkbox" class="enabler" id="naming_custom_sports"
                                   name="naming_custom_sports" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.NAMING_CUSTOM_SPORTS)]}/>
                                    ...
                                    <span class="component-desc">
                                        <select id="name_sports_presets" class="form-control input-sm">
                                            ...
                                            % for cur_preset in validator.name_sports_presets:
                                                <% tmp = validator.test_name(cur_preset) %>
                                                % if cur_preset == sickrage.srCore.CONFIG.NAMING_SPORTS_PATTERN:
                                                    <% is_sports_custom = False %>
                                                % endif
                                                    <option id="${cur_preset}" ${('', 'selected="selected"')[sickrage.srCore.CONFIG.NAMING_SPORTS_PATTERN == cur_preset]}>${os.path.join(tmp[b'dir'], tmp[b'name'])}</option>
                                            % endfor
                                            <option id="${sickrage.srCore.CONFIG.NAMING_SPORTS_PATTERN}" ${('', 'selected="selected"')[bool(is_sports_custom)]}>
                                                Custom...
                                            </option>
                                        </select>
                                    </span>
                                    ...
                                    <label class="nocheck">
                                        ...
                                        <span class="component-desc">
                                            <input type="text" name="naming_sports_pattern" id="naming_sports_pattern"
                                                   value="${sickrage.srCore.CONFIG.NAMING_SPORTS_PATTERN}"
                                                   class="form-control input-sm input350"/>
                        ...
                        <div class="field-pair">
                            <input type="checkbox" class="enabler" id="naming_custom_anime"
                                   name="naming_custom_anime" ${('', 'checked="checked"')[bool(sickrage.srCore.CONFIG.NAMING_CUSTOM_ANIME)]}/>
                        ...
                        <div id="content_naming_custom_anime">
                                    ...
                                    <span class="component-desc">
                                        <select id="name_anime_presets" class="form-control input-sm">
                                            ...
                                            % for cur_preset in validator.name_anime_presets:
                                                <% tmp = validator.test_name(cur_preset) %>
                                                % if cur_preset == sickrage.srCore.CONFIG.NAMING_ANIME_PATTERN:
                                                    <% is_anime_custom = False %>
                                                % endif
                                                    <option id="${cur_preset}" ${('', 'selected="selected"')[cur_preset == sickrage.srCore.CONFIG.NAMING_ANIME_PATTERN]}>${os.path.join(tmp[b'dir'], tmp[b'name'])}</option>
                                            % endfor
                                            <option id="${sickrage.srCore.CONFIG.NAMING_ANIME_PATTERN}" ${('', 'selected="selected"')[bool(is_anime_custom)]}>
                                                Custom...
                                            </option>
                                        </select>
                                    </span>
                                    ...
                                    <label class="nocheck">
                                        ...
                                        <span class="component-desc">
                                            <input type="text" name="naming_anime_pattern" id="naming_anime_pattern"
                                                   value="${sickrage.srCore.CONFIG.NAMING_ANIME_PATTERN}"
                                                   class="form-control input-sm input350"/>
                            ...
                            <div class="field-pair">
                                <label class="nocheck" for="naming_anime_multi_ep">
                                    ...
                                    <span class="component-desc">
                                        ...
                                        % for cur_multi_ep in sorted(multiEpStrings.iteritems(), key=lambda x: x[1]):
                                            <option value="${cur_multi_ep[0]}" ${('', 'selected="selected" class="selected"')[cur_multi_ep[0] == sickrage.srCore.CONFIG.NAMING_ANIME_MULTI_EP]}>${cur_multi_ep[1]}</option>
                                        % endfor
                                        </select>
                                    </span>
                                </label>
                            ...
                            <div class="field-pair">
                                <input type="radio" name="naming_anime" id="naming_anime"
                                       value="1" ${('', 'checked="checked"')[sickrage.srCore.CONFIG.NAMING_ANIME == 1]}/>
                            ...
                            <div class="field-pair">
                                <input type="radio" name="naming_anime" id="naming_anime_only"
                                       value="2" ${('', 'checked="checked"')[sickrage.srCore.CONFIG.NAMING_ANIME == 2]}/>
                            ...
                            <div class="field-pair">
                                <input type="radio" name="naming_anime" id="naming_anime_none"
                                       value="3" ${('', 'checked="checked"')[sickrage.srCore.CONFIG.NAMING_ANIME == 3]}/>

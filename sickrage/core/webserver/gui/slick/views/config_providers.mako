                        ...
                        <div class="component-group-desc">
                            ...
                            % if not sickrage.USE_NZBS or not sickrage.USE_TORRENTS:
                                <blockquote style="margin: 20px 0;">NZB/Torrent providers can be toggled in <b><a
                                        href="${srRoot}/config/search">Search Settings</a></b></blockquote>
                            % else:
                                <br>
                            % endif
                        ...
                        <fieldset class="component-group-list">
                            ...
                            % for curNewznabProvider in [curProvider for curProvider in sickrage.newznabProviderList]:
                                ...
                                <span class="component-desc">
                                    ...
                                    <p>when searching for a complete season depending on search mode you may return no
                                        results, this helps by restarting the search using the opposite search mode.</p>
                                </span>
                                            </label>
                                        </div>
                                    % endif
                                ...
                                <span class="component-desc">
                                    <p>when searching for complete seasons you can choose to have it look for season
                            ...
                            % for providerID, providerObj in sickrage.providersDict[TorrentProvider.type].items():
                                    ...
                                    <input type="number" step="0.1" name="${providerID}_ratio" id="${providerID}_ratio"
                                           value="${providerObj.ratio}" class="form-control input-sm input75"/>
                                            ...
                                            <label>
                                                <span class="component-title">&nbsp;</span>
                                <span class="component-desc">
                                    <p>stop transfer when ratio is reached<br>(-1 SickRage default to seed forever, or
                                ...
                                <span class="component-desc">
                                    ...
                                    <p>ONLY search on this provider if show info is defined as "Spanish" (avoid

                            ...
                            <label for="randomize_providers">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="randomize_providers" id="randomize_providers"
                                           class="enabler" ${('', 'checked="checked"')[bool(sickrage.srConfig.RANDOMIZE_PROVIDERS)]}/>
                            ...
                            <label for="download_propers">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="download_propers" id="download_propers"
                                           class="enabler" ${('', 'checked="checked"')[bool(sickrage.srConfig.DOWNLOAD_PROPERS)]}/>
...
% for curInterval in ('daily', '4h', '90m', '45m', '15m'):
    <option value="${curInterval}" ${('', 'selected="selected"')[sickrage.srConfig.PROPER_SEARCHER_INTERVAL == curInterval]}>${check_propers_interval_text[curInterval]}</option>
% endfor
                                        </select>
                                    </span>
                                </label>
                            ...
                            <label>
                                ...
                                <span class="component-desc">
                                    <input type="text" name="backlog_frequency"
                                           value="${sickrage.srConfig.BACKLOG_SEARCHER_FREQ}"
                                           class="form-control input-sm input75"/>
                                    <p>time in minutes between searches (min. ${sickrage.srConfig.MIN_BACKLOG_SEARCHER_FREQ}
                                        )</p>
                                </span>
                            </label>
                        </div>
                            ...
                            <label>
                                ...
                                <span class="component-desc">
                                    <input type="text" name="dailysearch_frequency"
                                           value="${sickrage.srConfig.DAILY_SEARCHER_FREQ}"
                                           class="form-control input-sm input75"/>
                                    <p>time in minutes between searches (min. ${sickrage.srConfig.MIN_DAILY_SEARCHER_FREQ})</p>
                                    </span>
                            </label>
                        </div>
                        ...
                        <div class="field-pair">
                            <label>
                                ...
                                <span class="component-desc">
                                    <input type="text" name="usenet_retention" value="${sickrage.srConfig.USENET_RETENTION}"
                                           class="form-control input-sm input75"/>
                        ...
                        <div class="field-pair">
                            <label>
                                ...
                                <span class="component-desc">
                                    <input type="text" name="ignore_words" value="${sickrage.srConfig.IGNORE_WORDS}"
                        ...
                        <div class="field-pair">
                            <label>
                                ...
                                <span class="component-desc">
                                    <input type="text" name="require_words" value="${sickrage.srConfig.REQUIRE_WORDS}"
                                           class="form-control input-sm input350" autocapitalize="off"/>
                        ...
                        <div class="field-pair">
                            <label>
                                ...
                                <span class="component-desc">
                                    <input type="text" name="ignored_subs_list" value="${sickrage.srConfig.IGNORED_SUBS_LIST}"
                                           class="form-control input-sm input350" autocapitalize="off"/>
                            ...
                            <label for="allow_high_priority">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="allow_high_priority"
                                           id="allow_high_priority" ${('', 'checked="checked"')[bool(sickrage.srConfig.ALLOW_HIGH_PRIORITY)]}/>
                            ...
                            <label for="use_nzbs">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="use_nzbs" class="enabler"
                                           id="use_nzbs" ${('', 'checked="checked"')[bool(sickrage.srConfig.USE_NZBS)]}/>
...
% for curAction in ('sabnzbd', 'blackhole', 'nzbget'):
    <option value="${curAction}" ${('', 'selected="selected"')[sickrage.srConfig.NZB_METHOD == curAction]}>${nzb_method_text[curAction]}</option>
% endfor
                                    </select>
                                </span>
                            </label>
                        ...
                        <div id="blackhole_settings">
                            <div class="field-pair">
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="nzb_dir" id="nzb_dir" value="${sickrage.srConfig.NZB_DIR}"
                                               class="form-control input-sm input350" autocapitalize="off"/>
                        ...
                        <div id="sabnzbd_settings">
                            <div class="field-pair">
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" id="sab_host" name="sab_host" value="${sickrage.srConfig.SAB_HOST}"
                                               class="form-control input-sm input350" autocapitalize="off"/>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="sab_username" id="sab_username"
                                               value="${sickrage.srConfig.SAB_USERNAME}" class="form-control input-sm input200"
                                               autocapitalize="off"/>
                                        <p>(blank for none)</p>
                                    </span>
                                </label>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="password" name="sab_password" id="sab_password"
                                               value="${sickrage.srConfig.SAB_PASSWORD}" class="form-control input-sm input200"
                                               autocapitalize="off"/>
                                        <p>(blank for none)</p>
                                    </span>
                                </label>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="sab_apikey" id="sab_apikey"
                                               value="${sickrage.srConfig.SAB_APIKEY}" class="form-control input-sm input350"
                                               autocapitalize="off"/>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="sab_category" id="sab_category"
                                               value="${sickrage.srConfig.SAB_CATEGORY}" class="form-control input-sm input200"/>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="sab_category_backlog" id="sab_category_backlog"
                                               value="${sickrage.srConfig.SAB_CATEGORY_BACKLOG}"
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="sab_category_anime" id="sab_category_anime"
                                               value="${sickrage.srConfig.SAB_CATEGORY_ANIME}"
                                               class="form-control input-sm input200"/>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="sab_category_anime_backlog"
                                               ...
                                               value="${sickrage.srConfig.SAB_CATEGORY_ANIME_BACKLOG}"
                                               class="form-control input-sm input200"/>
                        ...
                        <div id="nzbget_settings">
                                ...
                                <label for="nzbget_use_https">
                                    ...
                                    <span class="component-desc">
                                        <input id="nzbget_use_https" type="checkbox" class="enabler"
                                               name="nzbget_use_https" ${('', 'selected="selected"')[bool(sickrage.srConfig.NZBGET_USE_HTTPS)]}/>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="nzbget_host" id="nzbget_host"
                                               value="${sickrage.srConfig.NZBGET_HOST}" class="form-control input-sm input350"
                                               autocapitalize="off"/>
                            ...
                            <div class="field-pair">
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="nzbget_username" value="${sickrage.srConfig.NZBGET_USERNAME}"
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="password" name="nzbget_password" id="nzbget_password"
                                               value="${sickrage.srConfig.NZBGET_PASSWORD}"
                                               class="form-control input-sm input200" autocapitalize="off"/>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="nzbget_category" id="nzbget_category"
                                               value="${sickrage.srConfig.NZBGET_CATEGORY}"
                                               class="form-control input-sm input200"/>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="nzbget_category_backlog" id="nzbget_category_backlog"
                                               value="${sickrage.srConfig.NZBGET_CATEGORY_BACKLOG}"
                                               class="form-control input-sm input200"/>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="nzbget_category_anime" id="nzbget_category_anime"
                                               value="${sickrage.srConfig.NZBGET_CATEGORY_ANIME}"
                                               class="form-control input-sm input200"/>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="nzbget_category_anime_backlog"
                                               ...
                                               value="${sickrage.srConfig.NZBGET_CATEGORY_ANIME_BACKLOG}"
                                               class="form-control input-sm input200"/>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <select name="nzbget_priority" id="nzbget_priority" class="form-control input-sm">
                                            <option value="-100" ${('', 'selected="selected"')[sickrage.srConfig.NZBGET_PRIORITY == -100]}>
                                                Very low
                                            </option>
                                            <option value="-50" ${('', 'selected="selected"')[sickrage.srConfig.NZBGET_PRIORITY == -50]}>
                                                Low
                                            </option>
                                            <option value="0" ${('', 'selected="selected"')[sickrage.srConfig.NZBGET_PRIORITY == 0]}>
                                                Normal
                                            </option>
                                            <option value="50" ${('', 'selected="selected"')[sickrage.srConfig.NZBGET_PRIORITY == 50]}>
                                                High
                                            ...
                                            <option value="900" ${('', 'selected="selected"')[sickrage.srConfig.NZBGET_PRIORITY == 900]}>
                                                Force
                                            </option>
                                        </select>
                            ...
                            <label for="use_torrents">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="use_torrents" class="enabler"
                                           id="use_torrents" ${('', 'checked="checked"')[bool(sickrage.srConfig.USE_TORRENTS)]}/>
                            ...
                            <label for="torrent_method">
                                ...
                                <select name="torrent_method" id="torrent_method" class="form-control input-sm">
                                    ...
                                    % for curAction in ('blackhole', 'utorrent', 'transmission', 'deluge', 'deluged', 'download_station', 'rtorrent', 'qbittorrent', 'mlnet'):
                                        <option value="${curAction}" ${('', 'selected="selected"')[sickrage.srConfig.TORRENT_METHOD == curAction]}>${torrent_method_text[curAction]}</option>
                                    % endfor
                                </select>
                                </span>
                            </label>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="torrent_dir" id="torrent_dir"
                                               value="${sickrage.srConfig.TORRENT_DIR}" class="form-control input-sm input350"
                                               autocapitalize="off"/>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="torrent_host" id="torrent_host"
                                               value="${sickrage.srConfig.TORRENT_HOST}" class="form-control input-sm input350"
                                               autocapitalize="off"/>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="torrent_rpcurl" id="torrent_rpcurl"
                                               value="${sickrage.srConfig.TORRENT_RPCURL}" class="form-control input-sm input350"
                                               autocapitalize="off"/>
                                        <div class="clear-left">
                                ...
                                <label for="torrent_verify_cert">
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="torrent_verify_cert" class="enabler"
                                               id="torrent_verify_cert" ${('', 'checked="checked"')[bool(sickrage.srConfig.TORRENT_VERIFY_CERT)]}/>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="torrent_username" id="torrent_username"
                                               value="${sickrage.srConfig.TORRENT_USERNAME}"
                                               class="form-control input-sm input200" autocapitalize="off"/>
                                        <p>(blank for none)</p>
                                    </span>
                                </label>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="password" name="torrent_password" id="torrent_password"
                                               value="${sickrage.srConfig.TORRENT_PASSWORD}"
                                               class="form-control input-sm input200" autocapitalize="off"/>
                                        <p>(blank for none)</p>
                                    </span>
                                </label>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="torrent_label" id="torrent_label"
                                               value="${sickrage.srConfig.TORRENT_LABEL}"
                                               class="form-control input-sm input200"/>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="torrent_label_anime" id="torrent_label_anime"
                                               value="${sickrage.srConfig.TORRENT_LABEL_ANIME}"
                                               class="form-control input-sm input200"/>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="torrent_path" id="torrent_path"
                                               value="${sickrage.srConfig.TORRENT_PATH}" class="form-control input-sm input350"
                                               autocapitalize="off"/>
                            ...
                            <div class="field-pair" id="torrent_seed_time_option">
                                <label>
                                    ...
                                    <span class="component-desc"><input type="number" step="1" name="torrent_seed_time"
                                                                        ...
                                                                        value="${sickrage.srConfig.TORRENT_SEED_TIME}"
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="torrent_paused" class="enabler"
                                               id="torrent_paused" ${('', 'checked="checked"')[bool(sickrage.srConfig.TORRENT_PAUSED)]}/>
                                ...
                                <label>
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="torrent_high_bandwidth" class="enabler"
                                               id="torrent_high_bandwidth" ${('', 'checked="checked"')[bool(sickrage.srConfig.TORRENT_HIGH_BANDWIDTH)]}/>

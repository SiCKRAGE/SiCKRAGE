                    ...
                    <div id="core-component-group1" class="component-group">
                        ...
                        <fieldset class="component-group-list">
                            <div class="field-pair">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="randomize_providers" id="randomize_providers"
                                           class="enabler" ${('', 'checked="checked"')[bool(sickrage.RANDOMIZE_PROVIDERS)]}/>
                            ...
                            <div class="field-pair">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="download_propers" id="download_propers"
                                           class="enabler" ${('', 'checked="checked"')[bool(sickrage.DOWNLOAD_PROPERS)]}/>
                                    ...
                                    <span class="component-desc">
                                        <select id="check_propers_interval" name="check_propers_interval"
                                            ...
                                            % for curInterval in ('daily', '4h', '90m', '45m', '15m'):
                                                <option value="${curInterval}" ${('', 'selected="selected"')[sickrage.PROPER_SEARCHER_INTERVAL == curInterval]}>${check_propers_interval_text[curInterval]}</option>
                                            % endfor
                                        </select>
                                    </span>
                                    </label>
                            ...
                            <div class="field-pair">
                                ...
                                <span class="component-desc">
                                    <input type="text" name="backlog_frequency"
                                           value="${sickrage.BACKLOG_SEARCHER_FREQ}"
                                           class="form-control input-sm input75"/>
                                    <p>time in minutes between searches (min. ${sickrage.MIN_BACKLOG_SEARCHER_FREQ}
                                        )</p>
                                </span>
                                </label>
                            </div>
                            ...
                            <div class="field-pair">
                                ...
                                <span class="component-desc">
                                    <input type="text" name="dailysearch_frequency"
                                           value="${sickrage.DAILY_SEARCHER_FREQ}"
                                           class="form-control input-sm input75"/>
                                    <p>time in minutes between searches (min. ${sickrage.MIN_DAILY_SEARCHER_FREQ})</p>
                                    </span>
                                </label>
                            </div>
                            ...
                            <div class="field-pair">
                                ...
                                <span class="component-desc">
                                    <input type="text" name="usenet_retention" value="${sickrage.USENET_RETENTION}"
                                           class="form-control input-sm input75"/>
                            ...
                            <div class="field-pair">
                                ...
                                <span class="component-desc">
                                    <input type="text" name="ignore_words" value="${sickrage.IGNORE_WORDS}"
                            ...
                            <div class="field-pair">
                                ...
                                <span class="component-desc">
                                    <input type="text" name="require_words" value="${sickrage.REQUIRE_WORDS}"
                                           class="form-control input-sm input350" autocapitalize="off"/>
                            ...
                            <div class="field-pair">
                                ...
                                <span class="component-desc">
                                    <input type="text" name="ignored_subs_list" value="${sickrage.IGNORED_SUBS_LIST}"
                                           class="form-control input-sm input350" autocapitalize="off"/>
                            ...
                            <div class="field-pair">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="allow_high_priority"
                                           id="allow_high_priority" ${('', 'checked="checked"')[bool(sickrage.ALLOW_HIGH_PRIORITY)]}/>
                        ...
                        <fieldset class="component-group-list">
                            ...
                            <div class="field-pair">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="use_nzbs" class="enabler"
                                           id="use_nzbs" ${('', 'checked="checked"')[bool(sickrage.USE_NZBS)]}/>
                            ...
                            <div id="content_use_nzbs">
                                ...
                                <span class="component-desc">
                                    <select name="nzb_method" id="nzb_method" class="form-control input-sm">
                                        ...
                                        % for curAction in ('sabnzbd', 'blackhole', 'nzbget'):
                                            <option value="${curAction}" ${('', 'selected="selected"')[sickrage.NZB_METHOD == curAction]}>${nzb_method_text[curAction]}</option>
                                        % endfor
                                    </select>
                                </span>
                                    </label>
                                ...
                                <div id="blackhole_settings">
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="nzb_dir" id="nzb_dir" value="${sickrage.NZB_DIR}"
                                               class="form-control input-sm input350" autocapitalize="off"/>
                                ...
                                <div id="sabnzbd_settings">
                                    ...
                                    <span class="component-desc">
                                        <input type="text" id="sab_host" name="sab_host" value="${sickrage.SAB_HOST}"
                                               class="form-control input-sm input350" autocapitalize="off"/>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="sab_username" id="sab_username"
                                               value="${sickrage.SAB_USERNAME}" class="form-control input-sm input200"
                                               autocapitalize="off"/>
                                        <p>(blank for none)</p>
                                    </span>
                                        </label>
                                    ...
                                    <span class="component-desc">
                                        <input type="password" name="sab_password" id="sab_password"
                                               value="${sickrage.SAB_PASSWORD}" class="form-control input-sm input200"
                                               autocapitalize="off"/>
                                        <p>(blank for none)</p>
                                    </span>
                                        </label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="sab_apikey" id="sab_apikey"
                                               value="${sickrage.SAB_APIKEY}" class="form-control input-sm input350"
                                               autocapitalize="off"/>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="sab_category" id="sab_category"
                                               value="${sickrage.SAB_CATEGORY}" class="form-control input-sm input200"/>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="sab_category_backlog" id="sab_category_backlog"
                                               value="${sickrage.SAB_CATEGORY_BACKLOG}"
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="sab_category_anime" id="sab_category_anime"
                                               value="${sickrage.SAB_CATEGORY_ANIME}"
                                               class="form-control input-sm input200"/>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="sab_category_anime_backlog"
                                               ...
                                               value="${sickrage.SAB_CATEGORY_ANIME_BACKLOG}"
                                               class="form-control input-sm input200"/>
                                ...
                                <div id="nzbget_settings">
                                    ...
                                    <span class="component-desc">
                                        <input id="nzbget_use_https" type="checkbox" class="enabler"
                                               name="nzbget_use_https" ${('', 'selected="selected"')[bool(sickrage.NZBGET_USE_HTTPS)]}/>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="nzbget_host" id="nzbget_host"
                                               value="${sickrage.NZBGET_HOST}" class="form-control input-sm input350"
                                               autocapitalize="off"/>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="nzbget_username" value="${sickrage.NZBGET_USERNAME}"
                                    ...
                                    <span class="component-desc">
                                        <input type="password" name="nzbget_password" id="nzbget_password"
                                               value="${sickrage.NZBGET_PASSWORD}"
                                               class="form-control input-sm input200" autocapitalize="off"/>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="nzbget_category" id="nzbget_category"
                                               value="${sickrage.NZBGET_CATEGORY}"
                                               class="form-control input-sm input200"/>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="nzbget_category_backlog" id="nzbget_category_backlog"
                                               value="${sickrage.NZBGET_CATEGORY_BACKLOG}"
                                               class="form-control input-sm input200"/>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="nzbget_category_anime" id="nzbget_category_anime"
                                               value="${sickrage.NZBGET_CATEGORY_ANIME}"
                                               class="form-control input-sm input200"/>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="nzbget_category_anime_backlog"
                                               ...
                                               value="${sickrage.NZBGET_CATEGORY_ANIME_BACKLOG}"
                                               class="form-control input-sm input200"/>
                                    ...
                                    <span class="component-desc">
                                        <select name="nzbget_priority" id="nzbget_priority"
                                                class="form-control input-sm">
                                            <option value="-100" ${('', 'selected="selected"')[sickrage.NZBGET_PRIORITY == -100]}>
                                                Very low
                                            </option>
                                            <option value="-50" ${('', 'selected="selected"')[sickrage.NZBGET_PRIORITY == -50]}>
                                                Low
                                            </option>
                                            <option value="0" ${('', 'selected="selected"')[sickrage.NZBGET_PRIORITY == 0]}>
                                                Normal
                                            </option>
                                            <option value="50" ${('', 'selected="selected"')[sickrage.NZBGET_PRIORITY == 50]}>
                                                High
                                            ...
                                            <option value="900" ${('', 'selected="selected"')[sickrage.NZBGET_PRIORITY == 900]}>
                                                Force
                                            </option>
                                        </select>
                                ...
                                <input class="btn" type="button" value="Test SABnzbd" id="testSABnzbd"
                            ...
                            <div class="field-pair">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" name="use_torrents" class="enabler"
                                           id="use_torrents" ${('', 'checked="checked"')[bool(sickrage.USE_TORRENTS)]}/>
                                ...
                                <select name="torrent_method" id="torrent_method" class="form-control input-sm">
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="torrent_dir" id="torrent_dir"
                                               value="${sickrage.TORRENT_DIR}" class="form-control input-sm input350"
                                               autocapitalize="off"/>
                                        <div class="clear-left"><p><b>.torrent</b> files are stored at this location for
                                            external software to find and use</p></div>
                                    </span>
                                            </label>
                                        </div>
                                ...
                                <div id="options_torrent_clients">
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="torrent_host" id="torrent_host"
                                               value="${sickrage.TORRENT_HOST}" class="form-control input-sm input350"
                                               autocapitalize="off"/>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="torrent_rpcurl" id="torrent_rpcurl"
                                               value="${sickrage.TORRENT_RPCURL}" class="form-control input-sm input350"
                                               autocapitalize="off"/>
                                        <div class="clear-left">
                                        ...
                                        <select name="torrent_auth_type" id="torrent_auth_type"
                                            ...
                                            % for authvalue, authname in http_authtype.iteritems():
                                                <option id="torrent_auth_type_value"
                                                        value="${authvalue}" ${('', 'selected="selected"')[sickrage.TORRENT_AUTH_TYPE == authvalue]}>${authname}</option>
                                            % endfor
                                        </select>
                                        <p></p>
                                    </span>
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="torrent_verify_cert" class="enabler"
                                               id="torrent_verify_cert" ${('', 'checked="checked"')[bool(sickrage.TORRENT_VERIFY_CERT)]}/>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="torrent_username" id="torrent_username"
                                               value="${sickrage.TORRENT_USERNAME}"
                                               class="form-control input-sm input200" autocapitalize="off"/>
                                        <p>(blank for none)</p>
                                    </span>
                                        </label>
                                    ...
                                    <span class="component-desc">
                                        <input type="password" name="torrent_password" id="torrent_password"
                                               value="${sickrage.TORRENT_PASSWORD}"
                                               class="form-control input-sm input200" autocapitalize="off"/>
                                        <p>(blank for none)</p>
                                    </span>
                                        </label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="torrent_label" id="torrent_label"
                                               value="${sickrage.TORRENT_LABEL}"
                                               class="form-control input-sm input200"/>
                                        <span id="label_warning_deluge" style="display:none"><p>(blank spaces are not
                                            allowed)</p>
                                            <div class="clear-left"><p>note: label plugin must be enabled in Deluge
                                                clients</p></div>
                                        </span>
                                    </span>
                                        </label>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="torrent_label_anime" id="torrent_label_anime"
                                               value="${sickrage.TORRENT_LABEL_ANIME}"
                                               class="form-control input-sm input200"/>
                                        <span id="label_anime_warning_deluge" style="display:none"><p>(blank spaces are
                                            not allowed)</p>
                                            <div class="clear-left"><p>note: label plugin must be enabled in Deluge
                                                clients</p></div>
                                        </span>
                                    ...
                                    <span class="component-desc">
                                        <input type="text" name="torrent_path" id="torrent_path"
                                               value="${sickrage.TORRENT_PATH}" class="form-control input-sm input350"
                                               autocapitalize="off"/>
                                        <div class="clear-left"><p>where <span
                                                id="torrent_client">the torrent client</span> will save downloaded files
                                    ...
                                    <span class="component-desc"><input type="number" step="1" name="torrent_seed_time"
                                                                        ...
                                                                        value="${sickrage.TORRENT_SEED_TIME}"
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="torrent_paused" class="enabler"
                                               id="torrent_paused" ${('', 'checked="checked"')[bool(sickrage.TORRENT_PAUSED)]}/>
                                    ...
                                    <span class="component-desc">
                                        <input type="checkbox" name="torrent_high_bandwidth" class="enabler"
                                               id="torrent_high_bandwidth" ${('', 'checked="checked"')[bool(sickrage.TORRENT_HIGH_BANDWIDTH)]}/>
                                    ...
                                    <input class="btn" type="button" value="Test Connection" id="test_torrent"
                                           class="btn test-button"/>
                                    <input type="submit" class="btn config_submitter" value="Save Changes"/><br>
                                </div>

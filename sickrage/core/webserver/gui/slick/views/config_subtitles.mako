                            ...
                            <div id="content_use_subtitles">
                                <div class="field-pair">
                                    <label>
                                        ...
                                        <span class="component-desc"><input type="text" id="subtitles_languages"
                                ...
                                <div class="field-pair">
                                    <label class="clearfix" for="embedded_subtitles_all">
                                        ...
                                        <span class="component-desc">
                                            ...
                                            <p><b>Warning: </b>this will ignore <u>all</u> embedded subtitles for every
                                                video file!</p>
                                        </span>
                                    </label>
                                </div>
                                ...
                                <div class="field-pair">
                                    ...
                                    <label class="nocheck">
                                        ...
                                        <span class="component-desc">
                                            <ul>
                                                <li>See <a
                                                        href="https://github.com/SiCKRAGETV/SiCKRAGE/wiki/Subtitle%20Scripts"><font
                                                        color='red'><b>Wiki</b></font></a> for a script arguments
                                                    description.
                                                </li>
                                                <li>Additional scripts separated by <b>|</b>.</li>
                                                <li>Scripts are called after each episode has searched and downloaded
                                                    subtitles.
                                                </li>
                                                <li>For any scripted languages, include the interpreter executable
                                                    before the script. See the following example:
                                                </li>
                                                <ul>
                                                    <li>For Windows:
                            ...
                            <ul id="service_order_list">
                                % for curService in subtitle_searcher.sortedServiceList():
                                    <li class="ui-state-default" id="${curService[b'name']}">
                                        <input type="checkbox" id="enable_${curService[b'name']}"
                                               class="service_enabler" ${('', 'checked="checked"')[curService[b'enabled'] == True]}/>
                                        <a href="${helpers.anon_url(curService[b'url'])}" class="imgLink" target="_new">
                                            <img src="${srRoot}/images/subtitles/${curService[b'image']}"
                                                 alt="${curService[b'url']}" title="${curService[b'url']}" width="16"
                            ...
                            ##<div class="field-pair${(' hidden', '')[curService[b'enabled']}"> ## Need js to show/hide on save
                                ...
                                <div class="field-pair">
                                    <label class="nocheck" for="${curService[b'name']}_user">
                                        <span class="component-title">${curService[b'name'].capitalize()}
                                            User Name</span>
                                    <span class="component-desc">
                                        <input type="text" name="${curService[b'name']}_user"
                                               id="${curService[b'name']}_user"
                                               value="${providerLoginDict[curService[b'name']][b'user']}"
                                    ...
                                    <label class="nocheck" for="${curService[b'name']}_pass">
                                        <span class="component-title">${curService[b'name'].capitalize()}
                                            Password</span>
                                    <span class="component-desc">
                                        <input type="password" name="${curService[b'name']}_pass"
                                               id="${curService[b'name']}_pass"
                                               value="${providerLoginDict[curService[b'name']][b'pass']}"
                                               class="form-control input-sm input300" autocapitalize="off"/>
                                    </span>
                                    </label>
                                </div>

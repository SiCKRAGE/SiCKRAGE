                            ...
                            <fieldset class="component-group-list">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="archive_firstmatch"
                                           name="archive_firstmatch" ${('', 'checked="checked"')[show.archive_firstmatch == 1]} /> archive episode after the first best match is found from your archive quality list
                                </span>
                                    </label>
                                </div>
                                ...
                                <span class="component-desc">
                                    ...
                                    <div class="clear-left"><p>This only applies to episode filenames and the contents
                            ...
                            <fieldset class="component-group-list">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="anime"
                                           name="anime" ${('', 'checked="checked"')[show.is_anime == 1]}> check if the show is Anime and episodes are released as Show.265 rather than Show.S02E03<br>
                                    % if show.is_anime:
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="sports"
                                           name="sports" ${('', 'checked="checked"')[show.sports == 1]}/> check if the show is a sporting or MMA event released as Show.03.02.2010 rather than Show.S02E03<br>
                                    <span style="color:red">In case of an air date conflict between regular and special episodes, the later will be ignored.</span>
                                </span>
                                    </label>
                                </div>
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="scene"
                                           name="scene" ${('', 'checked="checked"')[show.scene == 1]} /> search by scene numbering (uncheck to search by indexer numbering)
                                </span>
                                    </label>
                                </div>
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="dvdorder"
                                           name="dvdorder" ${('', 'checked="checked"')[show.dvdorder == 1]} /> use the DVD order instead of the air order<br>
                                    <div class="clear-left"><p>A "Force Full Update" is necessary, and if you have
                                        existing episodes you need to sort them manually.</p></div>
                                </span>
                                    </label>
                                </div>
                            ...
                            <fieldset class="component-group-list">
                                ...
                                <span class="component-desc">
                                    <input type="text" id="rls_ignore_words" name="rls_ignore_words"
                                           ...
                                           class="form-control form-control-inline input-sm input350"/><br>
                                ...
                                <span class="component-desc">
                                    <input type="text" id="SceneName"
                                           class="form-control form-control-inline input-sm input200"/><input
                                        class="btn btn-inline" type="button" value="Add" id="addSceneName"/><br><br>
                                    <div class="pull-left">
                                        ...
                                        <div><input id="removeSceneName" value="Remove" class="btn float-left"
                                                    type="button" style="margin-top: 10px;"/></div>
                                    </div>
                                    <div class="clear-left"><p>This will affect episode search on NZB and torrent
                                        providers. This list overrides the original name; it doesn't append to it.</p>
                                    </div>
                                </span>
                                    </label>
                                </div>

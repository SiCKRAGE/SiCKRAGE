                ...
                % for hItem in historyResults:
                    ...
                    <tr>
                        ...
                        <td class="tvShow" width="35%"><a
                                href="${srRoot}/home/displayShow?show=${hItem["show_id"]}#S${hItem["season"]}E${hItem["episode"]}">${hItem["show_name"]}
                        ...
                        <td align="center" ${('', 'class="subtitles_column"')[curStatus == SUBTITLED]}>
                            % if curStatus == SUBTITLED:
                                <img width="16" height="11" style="vertical-align:middle;"
                                     src="${srRoot}/images/subtitles/flags/${hItem[b'resource']}.png"
                                     onError="this.onerror=null;this.src='${srRoot}/images/flags/unknown.png';">
                            % endif
                            <span style="cursor: help; vertical-align:middle;"
                                  title="${os.path.basename(hItem[b'resource'])}">${statusStrings[curStatus]}</span>
                        </td>
                        <td align="center">
                            ...
                            % else:
                                % if hItem[b"provider"] > 0:
                                    % if curStatus in [SNATCHED, FAILED]:
                                        ...
                                        % if provider != None:
                                            <img src="${srRoot}/images/providers/${provider.imageName}" width="16"
                                                 height="16"
                                                 style="vertical-align:middle;"/> <span
                                                style="vertical-align:middle;">${provider.name}</span>
                                        % else:
                                            <img src="${srRoot}/images/providers/missing.png" width="16" height="16"
                                                 style="vertical-align:middle;" title="missing provider"/> <span
                                                style="vertical-align:middle;">Missing Provider</span>
                                        % endif
                                    % else:
                                        <img src="${srRoot}/images/subtitles/${hItem[b'provider']}.png" width="16"
                                             height="16" style="vertical-align:middle;"/> <span
                ...
                % for hItem in compactResults:
                    <tr>
                        ...
                        <td class="tvShow" width="25%">
                            <span><a
                                    href="${srRoot}/home/displayShow?show=${hItem["show_id"]}#season-${hItem["season"]}">${hItem["show_name"]}
                        ...
                        % if sickrage.USE_SUBTITLES:
                            <td align="center">
                                % for action in sorted(hItem["actions"]):
                                    <% curStatus, curQuality = Quality.splitCompositeStatus(int(action["action"])) %>
                                    % if curStatus == SUBTITLED:
                                        <img src="${srRoot}/images/subtitles/${action[b'provider']}.png" width="16"
                                             height="16" style="vertical-align:middle;" alt="${action["provider"]}"
                                             title="${action["provider"].capitalize()}: ${os.path.basename(action["resource"])}"/>
                                        <span style="vertical-align:middle;"> / </span>
                                        <img width="16" height="11" style="vertical-align:middle;"
                                             src="${srRoot}/images/subtitles/flags/${action[b'resource']}.png"
                                             onError="this.onerror=null;this.src='${srRoot}/images/flags/unknown.png';"

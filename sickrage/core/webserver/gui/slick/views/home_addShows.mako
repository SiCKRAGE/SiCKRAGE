    ...
    <div id="addShowPortal">
        <a href="${srRoot}/home/addShows/newShow/" id="btnNewShow" class="btn btn-large">
            ...
            <div class="buttontext">
                ...
                <p>For shows that you haven't downloaded yet, this option finds a show on theTVDB.com, creates a
                    directory for it's episodes, and adds it to SickRage.</p>
            </div>
        </a>
            ...
            <a href="${srRoot}/home/addShows/recommendedShows/" id="btnNewShow" class="btn btn-large">
                ...
                <div class="buttontext">
                    ...
                    <p>For shows that you haven't downloaded yet, this option recommends shows to add based on your
                        Trakt.tv show library, creates a directory for its episodes, and adds it to SickRage.</p>
                </div>
            </a>
        ...
        <a href="${srRoot}/home/addShows/popularShows/" id="btnNewShow" class="btn btn-large">
            ...
            <div class="buttontext">
                ...
                <p>View IMDB's list of the most popular shows. This feature uses IMDB's MOVIEMeter algorithm to identify
                    popular TV Series.</p>
            </div>
        </a>
        ...
        <a href="${srRoot}/home/addShows/existingShows/" id="btnExistingShow" class="btn btn-large">
            ...
            <div class="buttontext">
                ...
                <p>Use this option to add shows that already have a folder created on your hard drive. SickRage will

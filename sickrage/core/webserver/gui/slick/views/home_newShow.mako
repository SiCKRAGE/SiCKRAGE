            ...
            <div id="core-component-group1" class="tab-pane active component-group">
                ...
                <form id="addShowForm" method="post" action="${srRoot}/home/addShows/addNewShow" accept-charset="utf-8">
                    ...
                    <fieldset class="sectionwrap">
                        ...
                        <div class="stepDiv">
                            <input type="hidden" id="indexer_timeout" value="${sickrage.INDEXER_TIMEOUT}"/>
                            ...
                            % else:
                                ...
                                <select name="providedIndexer" id="providedIndexer"
                                    ...
                                    <option value="0" ${('', 'selected="selected"')[provided_indexer == 0]}>All
                                        Indexers
                                    </option>
                                ...
                                <br><br>
                                <b>*</b> This will only affect the language of the retrieved metadata file contents and
                                episode filenames.<br>

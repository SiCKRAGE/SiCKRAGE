...
<%block name="content">
    ...
    <% imdb_tt = [show.imdbid for show in sickrage.showList if show.imdbid] %>
            ...
            <div class="popularShow">
                ...
                <div class="right">
                    ...
                    % if cur_result[b'imdb_tt'] not in imdb_tt:
                        <span class="imdb_sickrage_search"><a
                                href="${srRoot}/home/addShows/newShow/?search_string=${cur_result[b'name']}">
                            Add Show</a></span>
                    % else:

        ...
        <form name="processForm" method="post" action="processEpisode" style="line-height: 40px;">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="proc_dir" id="episodeDir"
                               class="form-control form-control-inline input-sm input350" autocapitalize="off"/>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span style="line-height: 0; font-size: 12px;"><i>&nbsp;(Check it to replace the file even if it
                            exists at higher quality)</i></span>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        <span style="line-height: 0; font-size: 12px;"><i>&nbsp;(Check it to delete files and folders
                            like auto processing)</i></span>
                    </td>
                </tr>

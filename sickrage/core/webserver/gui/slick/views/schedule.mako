            ...
            if cur_ep_airdate == today.date():
                ...
                <tr class="${show_div}">
                    <td align="center" nowrap="nowrap">
                        <% airDate = srdatetime.srDateTime.convert_to_setting(cur_result[b'localtime']) %>
                    ...
                    <td align="center" style="vertical-align: middle;">
                        % if cur_result[b'imdb_id']:
                            <a href="${anon_url('http://www.imdb.com/title/', cur_result[b'imdb_id'])}" rel="noreferrer"
                               ...
                               title="http://www.imdb.com/title/${cur_result[b'imdb_id']}"><img alt="[imdb]" height="16"
                                                                                                width="16"
                                                                                                src="${srRoot}/images/imdb.png"/></a>
                        % endif
                        ...
                        <a href="${srRoot}/home/searchEpisode?show=${cur_result[b'showid']}&amp;season=${cur_result[b'season']}&amp;episode=${cur_result[b'episode']}"
                           ...
                           class="forceUpdate epSearch">
                            <img alt="[search]" height="16" width="16" src="${srRoot}/images/search16.png"
                                 id="forceUpdateImage-${cur_result[b'showid']}"/>
                        </a>
                    </td>
                </tr>
            % endfor
            ...
            <tr>
                <th ${('class="nobg"', 'rowspan="2"')['banner' == layout]} valign="top">
                    <a href="${srRoot}/home/displayShow?show=${cur_result[b'showid']}">
                        <img alt="" class="${('posterThumb', 'bannerThumb')[layout == 'banner']}"
                             src="${showImage(cur_result[b'showid'], (layout, 'poster_thumb')[layout == 'poster'])}"/>
                    </a>
                </th>
                % if 'banner' == layout:
                    </tr>
                ...
                <td class="next_episode">
                    ...
                    <span class="tvshowTitleIcons">
                        ...
                        <span><a
                                href="${srRoot}/home/searchEpisode?show=${cur_result[b'showid']}&amp;season=${cur_result[b'season']}&amp;episode=${cur_result[b'episode']}"
                                title="Manual Search" id="forceUpdate-${cur_result[b'showid']}"
                                class="epSearch forceUpdate"><img alt="[search]" height="16" width="16"
                                                                  src="${srRoot}/images/search16.png"
                                                                  id="forceUpdateImage-${cur_result[b'showid']}"/></a></span>
                    </span>
                    </div>

                    <span class="title">Next Episode:</span>
                    <span>${'S%02iE%02i' % (int(cur_result[b'season']), int(cur_result[b'episode']))}
                        - ${cur_result[b'name']}</span>

                    <div class="clearfix">
                        <span class="title">Airs: </span><span
                            class="airdate">${srdatetime.srDateTime.srfdatetime(cur_result[b'localtime'])}</span>${('', '<span> on %s</span>' % cur_result[b'network'])[bool(cur_result[b'network'])]}
                    </div>
                    ...
                    <td style="vertical-align: top;">
                        <div>
                            % if cur_result[b'description']:
                                ...
                                <img class="ep_summaryTrigger" src="${srRoot}/images/plus.png" height="16" width="16"
                                     alt="" title="Toggle Summary"/>
                            ...
                            % else:
                                ...
                                <img class="ep_summaryTriggerNone" src="${srRoot}/images/plus.png" height="16"
                                     width="16" alt=""/>
                            % endif
                        </div>
                    </td>
                        ...
                        % if airday == day:
                            ...
                            <tr>
                                <td class="calendarShow">
                                    <div class="poster">
                                        <a title="${cur_result[b'show_name']}"
                                           href="${srRoot}/home/displayShow?show=${cur_result[b'showid']}"><img alt=""
                                                                                                                src="${srRoot}${showImage(cur_result[b'showid'], 'poster_thumb')}"/></a>
                                    </div>
                                    <div class="text">
                            <span class="airtime">

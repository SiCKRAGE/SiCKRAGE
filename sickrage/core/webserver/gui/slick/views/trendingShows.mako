    ...
    <div id="container">
        ...
        % else:
            ...
            <% show_url = 'http://www.trakt.tv/shows/%s' % cur_show[b'show'][b'ids'][b'slug'] %>
                ...
                <div class="trakt_show" data-name="${cur_show[b'show'][b'title']}"
                     data-rating="${cur_show[b'show'][b'rating']}" data-votes="${cur_show[b'show'][b'votes']}">
                    <div class="traktContainer">
                        <div class="trakt-image">
                            <a class="trakt-image" href="${anon_url(show_url)}" target="_blank"><img alt=""
                                                                                                     class="trakt-image"
                                                                                                     src="${cur_show[b'show'][b'images'][b'poster'][b'thumb']}"/></a>
                        </div>
                        ...
                        <div class="clearfix">
                            ...
                            <div class="traktShowTitleIcons">
                                <a href="${srRoot}/home/addShows/addTraktShow?indexer_id=${cur_show[b'show'][b'ids'][b'tvdb']}&amp;showName=${cur_show[b'show'][b'title']}"
                                   class="btn btn-xs">Add Show</a>
                                % if blacklist:
                                    <a href="${srRoot}/home/addShows/addShowToBlacklist?indexer_id=${cur_show[b'show'][b'ids'][b'tvdb'] or cur_show[b'show'][b'ids'][b'tvrage']}"

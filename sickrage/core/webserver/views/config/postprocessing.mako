                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input type="checkbox" name="process_automatically"
                               id="process_automatically" ${('', 'checked')[bool(sickrage.app.srConfig.PROCESS_AUTOMATICALLY)]}/>
                            ...
                            <div class="col-md-12">
                                <div class="input-group input350">
                                    ...
                                    <input name="tv_download_dir" id="tv_download_dir"
                                           value="${sickrage.app.srConfig.TV_DOWNLOAD_DIR}"
                                           class="form-control"
                                           autocapitalize="off"/>
                                </div>
                            </div>
                                ...
                                <div class="input-group input350">
                                    ...
                                    <select name="process_method" id="process_method" class="form-control"
                                        ...
                                        % for curAction in process_method_text:
                                            <option value="${curAction}" ${('', 'selected')[sickrage.app.srConfig.PROCESS_METHOD == curAction]}>${process_method_text[curAction]}</option>
                                        % endfor
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <div class="input-group input350">
                            ...
                            <input type="number" min="10" name="autopostprocessor_frequency"
                                   ...
                                   value="${sickrage.app.srConfig.AUTOPOSTPROCESSOR_FREQ}"
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input type="checkbox" name="postpone_if_sync_files"
                               id="postpone_if_sync_files" ${('', 'checked')[bool(sickrage.app.srConfig.POSTPONE_IF_SYNC_FILES)]}/>
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <div class="input-group input350">
                            ...
                            <input name="sync_files" id="sync_files"
                                   value="${sickrage.app.srConfig.SYNC_FILES}"
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">${_('Rename episode using the Episode')}
                        <input type="checkbox" name="rename_episodes"
                               id="rename_episodes" ${('', 'checked')[bool(sickrage.app.srConfig.RENAME_EPISODES)]}/>
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">${_('Create missing show directories')}
                        <input type="checkbox" name="create_missing_show_dirs"
                               id="create_missing_show_dirs" ${('', 'checked')[bool(sickrage.app.srConfig.CREATE_MISSING_SHOW_DIRS)]}/>
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">${_('Add shows without creating a')}
                        <input type="checkbox" name="add_shows_wo_dir"
                               id="add_shows_wo_dir" ${('', 'checked')[bool(sickrage.app.srConfig.ADD_SHOWS_WO_DIR)]}/>
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">${_('Move srr/srt/sfv/etc files with the')}
                        <input type="checkbox" name="move_associated_files"
                               id="move_associated_files" ${('', 'checked')[bool(sickrage.app.srConfig.MOVE_ASSOCIATED_FILES)]}/>
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">${_('Rename the original .nfo file to')}
                        <input type="checkbox" name="nfo_rename"
                               id="nfo_rename" ${('', 'checked')[bool(sickrage.app.srConfig.NFO_RENAME)]}/>
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input type="checkbox" name="airdate_episodes"
                               id="airdate_episodes" ${('', 'checked')[bool(sickrage.app.srConfig.AIRDATE_EPISODES)]}/>
                        ...
                        <div class="input-group input350">
                            ...
                            <select name="file_timestamp_timezone" id="file_timestamp_timezone"
                                ...
                                % for curTimezone in ('local','network'):
                                    <option value="${curTimezone}" ${('', 'selected')[sickrage.app.srConfig.FILE_TIMESTAMP_TIMEZONE == curTimezone]}>${curTimezone}</option>
                                % endfor
                            </select>
                        </div>
                    </div>
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input id="unpack" type="checkbox"
                               name="unpack" ${('', 'checked')[bool(sickrage.app.srConfig.UNPACK)]} />
                        <label for="unpack">
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input type="checkbox" name="del_rar_contents"
                               id="del_rar_contents" ${('', 'checked')[bool(sickrage.app.srConfig.DELRARCONTENTS)]}/>
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input type="checkbox" name="no_delete"
                               id="no_delete" ${('', 'checked')[bool(sickrage.app.srConfig.NO_DELETE)]}/>
                        <label for="no_delete">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <div class="input-group input350">
                            ...
                            <input name="extra_scripts" id="extra_scripts"
                                   value="${'|'.join(sickrage.app.srConfig.EXTRA_SCRIPTS)}"
                                   class="form-control" autocapitalize="off"/>
                        </div>
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <div class="input-group input350">
                            ...
                            <select id="name_presets" class="form-control" title="Choose a naming pattern">
                                ...
                                % if cur_preset == sickrage.app.srConfig.NAMING_PATTERN:
                                    <% is_custom = False %>
                                % endif
                                    <option id="${cur_preset}" ${('', 'selected')[sickrage.app.srConfig.NAMING_PATTERN == cur_preset]}>${os.path.join(tmp['dir'], tmp['name'])}</option>
                                % endfor
                                <option id="${sickrage.app.srConfig.NAMING_PATTERN}" ${('', 'selected')[bool(is_custom)]}>
                                    Custom...
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                            <div class="input-group input350">
                                ...
                                <input name="naming_pattern" id="naming_pattern"
                                       value="${sickrage.app.srConfig.NAMING_PATTERN}"
                                       class="form-control"/>
                            </div>
                        ...
                        <div class="input-group input350">
                            ...
                            <select id="naming_multi_ep" name="naming_multi_ep" class="form-control"
                                ...
                                % for cur_multi_ep in sorted(multiEpStrings.items(), key=lambda x: x[1]):
                                    <option value="${cur_multi_ep[0]}" ${('', 'selected')[cur_multi_ep[0] == sickrage.app.srConfig.NAMING_MULTI_EP]}>${cur_multi_ep[1]}</option>
                                % endfor
                            </select>
                        </div>
                    </div>
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input type="checkbox" id="naming_strip_year"
                               name="naming_strip_year" ${('', 'checked')[bool(sickrage.app.srConfig.NAMING_STRIP_YEAR)]}/>
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input type="checkbox" class="enabler" id="naming_custom_abd"
                               name="naming_custom_abd" ${('', 'checked')[bool(sickrage.app.srConfig.NAMING_CUSTOM_ABD)]}/>
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                            <div class="input-group input350">
                                ...
                                <select id="name_abd_presets" class="form-control" title="Choose a naming pattern">
                                    ...
                                    % if cur_preset == sickrage.app.srConfig.NAMING_ABD_PATTERN:
                                        <% is_abd_custom = False %>
                                    % endif
                                        <option id="${cur_preset}" ${('', 'selected')[sickrage.app.srConfig.NAMING_ABD_PATTERN == cur_preset]}>${os.path.join(tmp['dir'], tmp['name'])}</option>
                                    % endfor
                                    <option id="${sickrage.app.srConfig.NAMING_ABD_PATTERN}" ${('', 'selected')[bool(is_abd_custom)]}>
                                        Custom...
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="naming_abd_pattern" id="naming_abd_pattern"
                                           value="${sickrage.app.srConfig.NAMING_ABD_PATTERN}"
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input type="checkbox" class="enabler" id="naming_custom_sports"
                               name="naming_custom_sports" ${('', 'checked')[bool(sickrage.app.srConfig.NAMING_CUSTOM_SPORTS)]}/>
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                            <div class="input-group input350">
                                ...
                                <select id="name_sports_presets" class="form-control" title="Choose a naming pattern">
                                    ...
                                    <% tmp = validator.test_name(cur_preset) %>
                                    % if cur_preset == sickrage.app.srConfig.NAMING_SPORTS_PATTERN:
                                        <% is_sports_custom = False %>
                                    % endif
                                        <option id="${cur_preset}" ${('', 'selected')[sickrage.app.srConfig.NAMING_SPORTS_PATTERN == cur_preset]}>${os.path.join(tmp['dir'], tmp['name'])}</option>
                                    % endfor
                                    <option id="${sickrage.app.srConfig.NAMING_SPORTS_PATTERN}" ${('', 'selected')[bool(is_sports_custom)]}>
                                        ${_('Custom...')}
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="naming_sports_pattern" id="naming_sports_pattern"
                                           value="${sickrage.app.srConfig.NAMING_SPORTS_PATTERN}"
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input type="checkbox" class="enabler" id="naming_custom_anime"
                               name="naming_custom_anime" ${('', 'checked')[bool(sickrage.app.srConfig.NAMING_CUSTOM_ANIME)]}/>
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                            <div class="input-group input350">
                                ...
                                <select id="name_anime_presets" class="form-control" title="Choose a naming pattern">
                                    ...
                                    <% tmp = validator.test_name(cur_preset) %>
                                    % if cur_preset == sickrage.app.srConfig.NAMING_ANIME_PATTERN:
                                        <% is_anime_custom = False %>
                                    % endif
                                        <option id="${cur_preset}" ${('', 'selected')[cur_preset == sickrage.app.srConfig.NAMING_ANIME_PATTERN]}>${os.path.join(tmp['dir'], tmp['name'])}</option>
                                    % endfor
                                    <option id="${sickrage.app.srConfig.NAMING_ANIME_PATTERN}" ${('', 'selected')[bool(is_anime_custom)]}>
                                        ${_('Custom...')}
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="naming_anime_pattern" id="naming_anime_pattern"
                                           value="${sickrage.app.srConfig.NAMING_ANIME_PATTERN}"
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                            <div class="input-group input350">
                                ...
                                <select id="naming_anime_multi_ep" name="naming_anime_multi_ep"
                                        ...
                                        class="form-control">
                                    % for cur_multi_ep in sorted(multiEpStrings.items(), key=lambda x: x[1]):
                                        <option value="${cur_multi_ep[0]}" ${('', 'selected="selected" class="selected"')[cur_multi_ep[0] == sickrage.app.srConfig.NAMING_ANIME_MULTI_EP]}>${cur_multi_ep[1]}</option>
                                    % endfor
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row field-pair">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                            <input type="radio" name="naming_anime" id="naming_anime"
                                   value="1" ${('', 'checked')[sickrage.app.srConfig.NAMING_ANIME == 1]}/>
                    ...
                    <div class="row field-pair">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                            <input type="radio" name="naming_anime" id="naming_anime_only"
                                   value="2" ${('', 'checked')[sickrage.app.srConfig.NAMING_ANIME == 2]}/>
                    ...
                    <div class="row field-pair">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                            <input type="radio" name="naming_anime" id="naming_anime_none"
                                   value="3" ${('', 'checked')[sickrage.app.srConfig.NAMING_ANIME == 3]}/>

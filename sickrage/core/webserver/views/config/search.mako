                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input type="checkbox" name="randomize_providers" id="randomize_providers"
                               class="enabler" ${('', 'checked')[bool(sickrage.app.srConfig.RANDOMIZE_PROVIDERS)]}/>
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input type="checkbox" name="download_propers" id="download_propers"
                               class="enabler" ${('', 'checked')[bool(sickrage.app.srConfig.DOWNLOAD_PROPERS)]}/>
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input type="checkbox" name="enable_rss_cache" id="enable_rss_cache"
                               class="enabler" ${('', 'checked')[bool(sickrage.app.srConfig.ENABLE_RSS_CACHE)]}/>
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input type="checkbox" name="enable_rss_cache_valid_shows" id="enable_rss_cache_valid_shows"
                               class="enabler" ${('', 'checked')[bool(sickrage.app.srConfig.ENABLE_RSS_CACHE_VALID_SHOWS)]}/>
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input type="checkbox" name="torrent_file_to_magnet" id="torrent_file_to_magnet"
                               class="enabler" ${('', 'checked')[bool(sickrage.app.srConfig.TORRENT_FILE_TO_MAGNET)]}/>
                            ...
                            <div class="input-group input350">
                                ...
                                <select id="check_propers_interval" name="check_propers_interval"
                                    ...
                                    % for curInterval in ('daily', '4h', '90m', '45m', '15m'):
                                        <option value="${curInterval}" ${('', 'selected')[sickrage.app.srConfig.PROPER_SEARCHER_INTERVAL == curInterval]}>${check_propers_interval_text[curInterval]}</option>
                                    % endfor
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <div class="input-group input350">
                            ...
                            <input name="backlog_frequency"
                                   ...
                                   value="${sickrage.app.srConfig.BACKLOG_SEARCHER_FREQ}"
                                   placeholder="${_('time in minutes')}"
                                   title="minimum allowed time ${sickrage.app.srConfig.MIN_BACKLOG_SEARCHER_FREQ} minutes"
                                   class="form-control"/>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <div class="input-group input350">
                            ...
                            <input name="dailysearch_frequency"
                                   value="${sickrage.app.srConfig.DAILY_SEARCHER_FREQ}"
                                   placeholder="${_('time in minutes')}"
                                   title="minimum allowed time ${sickrage.app.srConfig.MIN_DAILY_SEARCHER_FREQ} minutes"
                                   class="form-control"/>
                            <div class="input-group-addon">
                                min
                            </div>
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <div class="input-group input350">
                            ...
                            <input name="usenet_retention"
                                   value="${sickrage.app.srConfig.USENET_RETENTION}"
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <div class="input-group input350">
                            ...
                            <input name="ignore_words"
                                   value="${sickrage.app.srConfig.IGNORE_WORDS}"
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <div class="input-group input350">
                            ...
                            <input name="require_words"
                                   value="${sickrage.app.srConfig.REQUIRE_WORDS}"
                                   placeholder="${_('ex. word1,word2,word3')}"
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <div class="input-group input350">
                            ...
                            <input name="ignored_subs_list"
                                   value="${sickrage.app.srConfig.IGNORED_SUBS_LIST}"
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input type="checkbox" name="allow_high_priority"
                               id="allow_high_priority" ${('', 'checked')[bool(sickrage.app.srConfig.ALLOW_HIGH_PRIORITY)]}/>
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input id="use_failed_downloads" type="checkbox" class="enabler"
                               ...
                               name="use_failed_downloads" ${('', 'checked')[bool(sickrage.app.srConfig.USE_FAILED_DOWNLOADS)]} />
                    ...
                    <div class="row field-pair">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                            <input id="delete_failed" type="checkbox"
                                   ...
                                   name="delete_failed" ${('', 'checked')[bool(sickrage.app.srConfig.DELETE_FAILED)]}/>
            ...
            <fieldset class="col-lg-9 col-md-8 col-sm-8 col-xs-12 tab-pane-list">
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input type="checkbox" name="use_nzbs" class="enabler" title="Enable NZB searches"
                               id="use_nzbs" ${('', 'checked')[bool(sickrage.app.srConfig.USE_NZBS)]}/>
                ...
                <div id="content_use_nzbs">
                            ...
                            <div class="input-group input350">
                                ...
                                <select name="nzb_method" id="nzb_method" class="form-control" title="NZB Clients">
                                    ...
                                    % for curAction in ('sabnzbd', 'blackhole', 'nzbget'):
                                        <option value="${curAction}" ${('', 'selected')[sickrage.app.srConfig.NZB_METHOD == curAction]}>${nzb_method_text[curAction]}</option>
                                    % endfor
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    <input name="nzb_dir" id="nzb_dir"
                                           value="${sickrage.app.srConfig.NZB_DIR}"
                                           class="form-control" autocapitalize="off"/>
                                </div>
                                <label for="nzb_dir">
                                    <p>
                    ...
                    <div id="sabnzbd_settings">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input id="sab_host" name="sab_host"
                                           value="${sickrage.app.srConfig.SAB_HOST}"
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="sab_username" id="sab_username"
                                           value="${sickrage.app.srConfig.SAB_USERNAME}"
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input type="password" name="sab_password" id="sab_password"
                                           value="${sickrage.app.srConfig.SAB_PASSWORD}"
                                           placeholder="${_('blank = no authentication')}"
                                           class="form-control"
                                           autocapitalize="off"/>
                                </div>
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="sab_apikey" id="sab_apikey"
                                           value="${sickrage.app.srConfig.SAB_APIKEY}"
                                           class="form-control"
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="sab_category" id="sab_category"
                                           value="${sickrage.app.srConfig.SAB_CATEGORY}"
                                           placeholder="${_('ex. TV')}"
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="sab_category_backlog" id="sab_category_backlog"
                                           value="${sickrage.app.srConfig.SAB_CATEGORY_BACKLOG}"
                                           placeholder="${_('ex. TV')}"
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="sab_category_anime" id="sab_category_anime"
                                           value="${sickrage.app.srConfig.SAB_CATEGORY_ANIME}"
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="sab_category_anime_backlog"
                                           ...
                                           value="${sickrage.app.srConfig.SAB_CATEGORY_ANIME_BACKLOG}"
                                           placeholder="${_('ex. anime')}"
                        ...
                        % if sickrage.app.srConfig.ALLOW_HIGH_PRIORITY == True:
                            <div class="row field-pair">
                                <div class="col-lg-3 col-md-4 col-sm-5 col-xs-12">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="sab_forced" class="enabler"
                                           id="sab_forced" ${('', 'selected')[bool(sickrage.app.srConfig.SAB_FORCED)]}/>
                        ...
                        <div class="row field-pair">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input id="nzbget_use_https" type="checkbox" class="enabler"
                                       name="nzbget_use_https" ${('', 'selected')[bool(sickrage.app.srConfig.NZBGET_USE_HTTPS)]}/>
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="nzbget_host" id="nzbget_host"
                                           value="${sickrage.app.srConfig.NZBGET_HOST}"
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="nzbget_username"
                                           value="${sickrage.app.srConfig.NZBGET_USERNAME}"
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input type="password" name="nzbget_password" id="nzbget_password"
                                           value="${sickrage.app.srConfig.NZBGET_PASSWORD}"
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="nzbget_category" id="nzbget_category"
                                           value="${sickrage.app.srConfig.NZBGET_CATEGORY}"
                                           placeholder="${_('ex. TV')}"
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="nzbget_category_backlog" id="nzbget_category_backlog"
                                           value="${sickrage.app.srConfig.NZBGET_CATEGORY_BACKLOG}"
                                           placeholder="${_('ex. TV')}"
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="nzbget_category_anime" id="nzbget_category_anime"
                                           value="${sickrage.app.srConfig.NZBGET_CATEGORY_ANIME}"
                                           placeholder="${_('ex. anime')}"
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="nzbget_category_anime_backlog"
                                           ...
                                           value="${sickrage.app.srConfig.NZBGET_CATEGORY_ANIME_BACKLOG}"
                                           placeholder="${_('ex. anime')}"
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <select name="nzbget_priority" id="nzbget_priority"
                                            ...
                                            class="form-control">
                                        <option value="-100" ${('', 'selected')[sickrage.app.srConfig.NZBGET_PRIORITY == -100]}>
                                            ${_('Very low')}
                                        </option>
                                        <option value="-50" ${('', 'selected')[sickrage.app.srConfig.NZBGET_PRIORITY == -50]}>
                                            ${_('Low')}
                                        </option>
                                        <option value="0" ${('', 'selected')[sickrage.app.srConfig.NZBGET_PRIORITY == 0]}>
                                            ${_('Normal')}
                                        </option>
                                        <option value="50" ${('', 'selected')[sickrage.app.srConfig.NZBGET_PRIORITY == 50]}>
                                            ${_('High')}
                                        ...
                                        <option value="900" ${('', 'selected')[sickrage.app.srConfig.NZBGET_PRIORITY == 900]}>
                                            ${_('Force')}
                                        </option>
                                    </select>
                                </div>
                ...
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input type="checkbox" name="use_torrents" class="enabler"
                               id="use_torrents" ${('', 'checked')[bool(sickrage.app.srConfig.USE_TORRENTS)]}/>
                            ...
                            <div class="input-group input350">
                                ...
                                <select name="torrent_method" id="torrent_method" class="form-control"
                                    ...
                                    % for curAction in ('blackhole', 'utorrent', 'transmission', 'deluge', 'deluged', 'download_station', 'rtorrent', 'qbittorrent', 'mlnet', 'putio'):
                                        <option value="${curAction}" ${('', 'selected')[sickrage.app.srConfig.TORRENT_METHOD == curAction]}>${torrent_method_text[curAction]}</option>
                                    % endfor
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    <input name="torrent_dir" id="torrent_dir"
                                           value="${sickrage.app.srConfig.TORRENT_DIR}"
                                           class="form-control"
                                           autocapitalize="off"/>
                                </div>
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="torrent_host" id="torrent_host"
                                           value="${sickrage.app.srConfig.TORRENT_HOST}"
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="torrent_rpcurl" id="torrent_rpcurl"
                                           value="${sickrage.app.srConfig.TORRENT_RPCURL}"
                                    ...
                                    <select name="torrent_auth_type" id="torrent_auth_type" title="Client AUTH type"
                                        ...
                                        % for authvalue, authname in http_authtype.items():
                                            <option id="torrent_auth_type_value"
                                                    value="${authvalue}" ${('', 'selected')[sickrage.app.srConfig.TORRENT_AUTH_TYPE == authvalue]}>${authname}</option>
                                        % endfor
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row field-pair" id="torrent_verify_cert_option">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" name="torrent_verify_cert" class="enabler"
                                       id="torrent_verify_cert" ${('', 'checked')[bool(sickrage.app.srConfig.TORRENT_VERIFY_CERT)]}/>
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="torrent_username" id="torrent_username"
                                           value="${sickrage.app.srConfig.TORRENT_USERNAME}"
                                           placeholder="${_('blank = no authentication')}"
                                           class="form-control" autocapitalize="off"/>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input type="password" name="torrent_password" id="torrent_password"
                                           value="${sickrage.app.srConfig.TORRENT_PASSWORD}"
                                           placeholder="${_('blank = no authentication')}"
                                           class="form-control" autocapitalize="off"/>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="torrent_label" id="torrent_label"
                                           value="${sickrage.app.srConfig.TORRENT_LABEL}"
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input name="torrent_label_anime" id="torrent_label_anime"
                                           value="${sickrage.app.srConfig.TORRENT_LABEL_ANIME}"
                                           placeholder="${_('blank spaces are not allowed')}"
                                           title="label plugin must be enabled in Deluge clients"
                                           class="form-control"/>
                                </div>
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    <input name="torrent_path" id="torrent_path"
                                           value="${sickrage.app.srConfig.TORRENT_PATH}"
                                           class="form-control"
                                           autocapitalize="off"/>
                                </div>
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="input-group input350">
                                    ...
                                    <input type="number"
                                           ...
                                           value="${sickrage.app.srConfig.TORRENT_SEED_TIME}"
                        ...
                        <div class="row field-pair" id="torrent_paused_option">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" name="torrent_paused" class="enabler"
                                       id="torrent_paused" ${('', 'checked')[bool(sickrage.app.srConfig.TORRENT_PAUSED)]}/>
                        ...
                        <div class="row field-pair" id="torrent_high_bandwidth_option">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" name="torrent_high_bandwidth" class="enabler"
                                       id="torrent_high_bandwidth" ${('', 'checked')[bool(sickrage.app.srConfig.TORRENT_HIGH_BANDWIDTH)]}/>

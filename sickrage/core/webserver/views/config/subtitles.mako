...
<%block name="pages">
    <%
        providerLoginDict = {'legendastv': {'user': sickrage.app.srConfig.LEGENDASTV_USER, 'pass': sickrage.app.srConfig.LEGENDASTV_PASS},
                            'itasa': {'user': sickrage.app.srConfig.ITASA_USER, 'pass': sickrage.app.srConfig.ITASA_PASS},
                            'addic7ed': {'user': sickrage.app.srConfig.ADDIC7ED_USER, 'pass': sickrage.app.srConfig.ADDIC7ED_PASS},
                            'opensubtitles': {'user': sickrage.app.srConfig.OPENSUBTITLES_USER, 'pass': sickrage.app.srConfig.OPENSUBTITLES_PASS}}
    %>
            ...
            <fieldset class="col-lg-9 col-md-8 col-sm-8 col-xs-12 tab-pane-list">
                <div class="row field-pair">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                        <input type="checkbox"
                               class="enabler" ${('', ' checked="checked"')[bool(sickrage.app.srConfig.USE_SUBTITLES)]}
                    ...
                    <div class="row field-pair">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                            <input type="checkbox" name="subtitles_history"
                                   id="subtitles_history" ${('', 'checked')[bool(sickrage.app.srConfig.SUBTITLES_HISTORY)]}/>
                    ...
                    <div class="row field-pair">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                            <input type="checkbox" name="subtitles_multi"
                                   id="subtitles_multi" ${('', 'checked')[bool(sickrage.app.srConfig.SUBTITLES_MULTI)]}/>
                    ...
                    <div class="row field-pair">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                            <input type="checkbox" name="embedded_subtitles_all"
                                   id="embedded_subtitles_all" ${('', 'checked')[bool(sickrage.app.srConfig.EMBEDDED_SUBTITLES_ALL)]}/>
                    ...
                    <div class="row field-pair">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                            <input type="checkbox" name="subtitles_hearing_impaired"
                                   id="subtitles_hearing_impaired" ${('', 'checked')[bool(sickrage.app.srConfig.SUBTITLES_HEARING_IMPAIRED)]}/>
                    ...
                    <div class="row field-pair">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                            <div class="input-group input350">
                                ...
                                <input value="${sickrage.app.srConfig.SUBTITLES_DIR}"
                                       id="subtitles_dir"
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                            <div class="input-group input350">
                                ...
                                <input type="number" name="subtitles_finder_frequency"
                                       value="${sickrage.app.srConfig.SUBTITLE_SEARCHER_FREQ}" hours="1"
                                       placeholder="${_('1')}"
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                            <div class="input-group input350">
                                ...
                                <input name="subtitles_extra_scripts" id="subtitles_extra_scripts"
                                       value="<% '|'.join(sickrage.app.srConfig.SUBTITLES_EXTRA_SCRIPTS) %>"

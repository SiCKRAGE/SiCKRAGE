                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col text-center">
                                    ...
                                    <div class="col"><i>${searchQueueLength['daily']} ${_('pending items')}</i></div>
                                </div>
                                <div class="col text-center">
                                    <div class="col badge badge-warning">${_('Backlog:')}</div>
                                    <div class="col"><i>${searchQueueLength['backlog']} ${_('pending items')}</i></div>
                                </div>
                                <div class="col text-center">
                                    <div class="col badge badge-warning">${_('Manual:')}</div>
                                    <div class="col"><i>${searchQueueLength['manual']} ${_('pending items')}</i></div>
                                </div>
                                <div class="col text-center">
                                    <div class="col badge badge-warning">${_('Failed:')}</div>
                                    <div class="col"><i>${searchQueueLength['failed']} ${_('pending items')}</i></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col text-center">
                                    ...
                                    <div class="col"><i>${postProcessorQueueLength['auto']} ${_('pending items')}</i></div>
                                </div>
                                <div class="col text-center">
                                    <div class="col badge badge-warning">${_('Manual:')}</div>
                                    <div class="col"><i>${postProcessorQueueLength['manual']} ${_('pending items')}</i></div>
                                </div>
                            </div>
                        </div>
                    </div>

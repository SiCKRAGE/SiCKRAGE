...
class AlexaNotifier(Notifiers):
    ...
    def _notify_alexa(self, message='', force=False):
        if not (sickrage.app.config.use_twilio or force):
            return False

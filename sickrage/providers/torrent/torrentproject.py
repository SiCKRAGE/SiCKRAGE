            ...
            for search_string in search_strings[mode]:
                ...
                for i in torrents:
                    ...
                    if seeders < self.minseed or leechers < self.minleech:
                        if mode is not 'RSS':
                            sickrage.srCore.LOGGER.debug("Torrent doesn't meet minimum seeds & leechers not selecting : %s" % title)
                        continue
                    ...
                    try:
                        ...
                        sickrage.srCore.LOGGER.debug("Torrent has less than 10 seeds getting dyn trackers: " + title)
